...
public class Hemodinamia_Diagnostico
{
    public int id { get; set; }
...
public class Hemodinamia_Cirugia
{
    public int id { get; set; }
...
[Serializable]
public class Hemodinamia_Anestesia
{
    public int id { get; set; }
...
public class Hemodinamia_Tipo
{
    public int id { get; set; }
    public string tipo { get; set; }
}

public class Hemodinamia_Listado
{
...
public class Hemodinamia_MotivoSusp
{
    public int id { get; set; }
...
[Serializable]
public class Hemodinamia_Insumo_Pre
{
    public Hemodinamia_Insumo_Pre()
    {
...
[Serializable]
public class Hemodinamia_Insumo
{
    public Hemodinamia_Insumo()
    {
...
public class Hemodinamia_PreAnes_Enc
{
    public int Id { get; set; }
    public string Paciente { get; set; }
...
public class HemodinamiaPreQuirurgico
{
    public int id { get; set; }
    public string paciente { get; set; }
    public string cama { get; set; }
...
[Serializable]
public class Hemodinamia_ControlSignosVitales
{
...
public class Hemodinamia_RecPosAnestesia
{
    public int Cirugia_Id { get; set; }
...
public class Hemodinamia_Protocolos
{
...
[Serializable]
public class Hemodinamia_Resolucion28
{
    public int id { get; set; }
    public string nhc { get; set; }
...
[Serializable]
public class HemodinamiaProtesis
{
    public int id { get; set; }
...
public class Hemodinamia_Protesis_Cab
{
    public int id { get; set; }
...
public class Hemodinamia_DiagnosticoICD10
{
    public string Codigo { get; set; }
    public string Id { get; set; }
    public string Descripcion { get; set; }

    public Hemodinamia_DiagnosticoICD10()
    {
    }

    public Hemodinamia_DiagnosticoICD10(string Id, string Descripcion)
    {
        this.Id = Id;
...
public class Hemodinamia_Sala_y_Cama
{
    public string Sala { get; set; }
    public string Cama { get; set; }
}
...
public class Hemodinamia_turnos_totales
{
...
public class Hemodinamia_Insumo_PRE_Anestesia_Listado
{
...
public class Hemodinamia_Insumo_y_Protesis_Insumo
{
...
public class Protocolo_Hemodinamia_Info
{
    public string Hora_Inicio { get; set; }
    public string Hora_Fin { get; set; }
    public string Diagnostico { get; set; }
...
public class Hemodinamia_Parte_Anestesia
{
    public string Especialidad { get; set; }
...
public class Hemodinamia_Post_csv
{
    public long id { get; set; }    
...
public class Hemodinamia_Post_Monitoreo
{
    public long id { get; set; }    
...
public class Hemodinamia_Post_Gral
{
...
public class Hemodinamia_Estado
{
...
public class Hemodinamia_Permisos_Tiempo
{
...
public class Hemodinamia_INSUMO_EXTRA
{
    public long id { get; set; }
    public string codigo { get; set; }
    public string nombre { get; set; }    
    ...
    public int OrtopediaID { get; set; }

    public bool material_uom { get; set; }
    public int cantidad { get; set; }
        
    public long medida { get; set; }
...
public class Hemodinamia_INSUMO_EXTRA_STOCK
{
    public long insumo_id { get; set; }
    public int stock { get; set; }
    public string fecha { get; set; }
    public long usuario_id { get; set; }
    public string ultima_fecha_guardada { get; set; }    
}


public class Hemodinamia_INSUMO_EXTRA_SERVICIO
{
    public long id { get; set; }    
    public string descripcion { get; set; }
...
public class Hemodinamia_INSUMO_EXTRA_ORTOPEDIA {
    public long id { get; set; }
    public string descripcion { get; set; }    
}


public class Hemodinamia_INSUMO_EXTRA_MOTIVO
{
    public long id { get; set; }
    public string descripcion { get; set; }
}
...
public class Hemodinamia_INSUMO_EXTRA_MOVIMIENTO
{
...
public class Hemodinamia_INSUMO_EXTRA_RUBRO
{
...
public class Hemodinamia_INSUMO_EXTRA_TIPO
{
...
public class Hemodinamia_INSUMO_EXTRA_MEDIDA
{
    public long TipoId { get; set; }
...
public class Hemodinamia_IMPRESION_ESTADOS
{
    public Boolean R28 { get; set; }
    public Boolean Protocolo { get; set; }
    public Boolean Post { get; set; }
    public Boolean InsumoQX { get; set; }
    public Boolean Parte { get; set; }
    public Boolean Extra_v { get; set; }
    public Boolean Extra_n { get; set; }
    public Boolean Pre { get; set; }
}
