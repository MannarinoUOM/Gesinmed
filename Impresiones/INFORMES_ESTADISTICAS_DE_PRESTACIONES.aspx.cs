...
public partial class Impresiones_INFORMES_ESTADISTICAS_DE_PRESTACIONES : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[5] = new ReportParameter("Especialidad", Request.QueryString["Especialidad"]);
