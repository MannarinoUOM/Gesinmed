...
public partial class Impresiones_ImpresionRendicionFarmacia : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=RendicionFarmacia." + "PDF"));
