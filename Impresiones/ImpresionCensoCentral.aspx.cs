...
public partial class Impresiones_ImpresionCensoCentral : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[3] = new ReportParameter("imagenValidez", "http://" + Request.Url.Host + ":" + Request.Url.Port + HttpContext.Current.Request.ApplicationPath + "/img/error.jpg");
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=CensoDiario_" + DateTime.Now.ToShortDateString()  + ".PDF"));
