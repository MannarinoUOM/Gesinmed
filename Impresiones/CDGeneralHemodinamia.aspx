<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CDGeneralHemodinamia.aspx.cs" Inherits="Impresiones_CDGeneral_Hemodinamia" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\CDGeneralHemodinamia.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteGeneral" runat="server" 
            ...
            SelectCommand="H2_AtConsultorio_CargadePGeneralHemodinamia_Impresion" 
