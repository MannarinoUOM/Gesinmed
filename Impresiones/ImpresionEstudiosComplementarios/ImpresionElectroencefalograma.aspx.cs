...
public partial class Impresiones_ImpresionElectroencefalograma : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=ImpresionElectroencefalograma." + "PDF"));
