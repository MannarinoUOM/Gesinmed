<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionPolisomnografia.aspx.cs" Inherits="Impresiones_ImpresionPolisomnografia" %>
...
<body>
    ...
    <div style="height: 362px">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            Width="697px">
            <LocalReport ReportPath="EstudiosComplementarios\Polisomnografia.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="SqlDataSource1_Selecting1" 
                        Name="DataSetPolisomnografia" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1_Selecting1" runat="server" ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>"
            SelectCommand="Impresion_Polisomnografia" SelectCommandType="StoredProcedure"
