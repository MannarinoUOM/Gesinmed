<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionElectroencefalograma.aspx.cs"
    Inherits="Impresiones_ImpresionElectroencefalograma" %>
...
<body>
    ...
    <div style="height: 362px">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            Width="697px">
            <LocalReport ReportPath="EstudiosComplementarios\Electroencefalograma.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="Fuente_Centro" Name="Fuente_Centro" />
                    <rsweb:ReportDataSource DataSourceId="SqlDataSource1_Selecting1" 
                        Name="DataSetElectroencefalograma" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1_Selecting1" runat="server" ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>"
            SelectCommand="Impresion_Electroencefalograma" SelectCommandType="StoredProcedure"
