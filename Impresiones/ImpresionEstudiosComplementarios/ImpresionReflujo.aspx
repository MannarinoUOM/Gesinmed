<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionReflujo.aspx.cs" Inherits="Impresiones_ImpresionReflujo" %>
...
<body>
    ...
    <div style="height: 362px">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            Width="697px">
            <LocalReport ReportPath="EstudiosComplementarios\Reflujo.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="SqlDataSource1_Selecting1" runat="server" ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>"
            SelectCommand="Impresion_Reflujo" SelectCommandType="StoredProcedure"
