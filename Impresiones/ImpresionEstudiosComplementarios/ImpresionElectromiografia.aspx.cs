...
public partial class Impresiones_ImpresionElectromiografia : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=ImpresionElectromiografia." + "PDF"));
