...
public partial class Impresiones_ImpresionRiesgoQuirurgico : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=ImpresionRiesgoQuirurgico." + "PDF"));
