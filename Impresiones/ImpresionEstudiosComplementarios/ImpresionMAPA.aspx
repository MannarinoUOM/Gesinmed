<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionMAPA.aspx.cs" Inherits="Impresiones_ImpresionMAPA" %>
...
<body>
    ...
    <div style="height: 388px; width: 630px;">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
            InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt"
            Width="697px">
            <LocalReport ReportPath="EstudiosComplementarios\MAPA.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="Fuente_Centro" Name="FuenteCentro" />
                    <rsweb:ReportDataSource DataSourceId="SqlDataSource1_Selecting1" Name="DataSetMAPA" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1_Selecting1" runat="server" ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>"
            SelectCommand="Impresion_MAPA" SelectCommandType="StoredProcedure"
