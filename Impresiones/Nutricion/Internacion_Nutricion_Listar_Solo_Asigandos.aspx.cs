...
public partial class Impresiones_Nutricion_Internacion_Nutricion_Listar_Solo_Asigandos : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //parameters[1] = new ReportParameter("Usuario", "Impreso Por: " + User.Identity.Name + ". Fecha: " + DateTime.Now.ToString("dd/MM/yyyy HH:mm"));
