...
public partial class Impresiones_Compras_Compras_Entregas_Internacion : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[2] = new ReportParameter("P_ID", Request.QueryString["P_ID"]);
            parameters[3] = new ReportParameter("G_ExpId", Request.QueryString["G_ExpId"]); 
