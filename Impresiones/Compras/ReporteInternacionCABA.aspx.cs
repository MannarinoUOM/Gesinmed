...
public partial class Impresiones_Compras_ReporteInternacionCABA : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["Usuario"] != null)
            {
                ...
                parameters[4] = new ReportParameter("afiliado", Request.QueryString["afiliado"]);
