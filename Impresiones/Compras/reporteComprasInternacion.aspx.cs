...
public partial class Impresiones_Compras_reporteComprasInternacion : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["Usuario"] != null)
            {
                ...
                parameters[2] = new ReportParameter("tipo", Request.QueryString["tipo"]);
                parameters[3] = new ReportParameter("afiliado", Request.QueryString["afiliado"]);
