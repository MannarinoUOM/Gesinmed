...
public partial class Impresiones_Compras_Compras_RemitoProveedores_Administracion : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Compras_Remito." + "PDF"));
