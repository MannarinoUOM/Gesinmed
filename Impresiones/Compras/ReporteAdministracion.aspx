<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReporteAdministracion.aspx.cs" Inherits="Impresiones_Compras_ReporteAdministracion" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Compras\ReporteAdministracion.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_COMPRAS_REPORTE_ADM" SelectCommandType="StoredProcedure">
            <SelectParameters>
                ...
                <asp:QueryStringParameter Name="Opcion" QueryStringField="Filtro" 
                    Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
