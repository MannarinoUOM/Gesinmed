...
public partial class Impresiones_Compras_ReporteAdministracion : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Reporte_Administracion." + "PDF"));
