...
public partial class Impresiones_ReportesQuirofano_Cirugias_Monotributistas : System.Web.UI.Page
{
    ...
    public void pdf()
    {
        if (Existe)
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Cirugias_Monotributistas." + "PDF"));
