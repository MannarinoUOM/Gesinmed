...
public partial class Impresiones_ReportesQuirofano_Listados_Quirofano_stock_insumos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[4] = new ReportParameter("egreso", Request.QueryString["egreso"]);
            parameters[5] = new ReportParameter("PDF", Request.QueryString["PDF"]);
