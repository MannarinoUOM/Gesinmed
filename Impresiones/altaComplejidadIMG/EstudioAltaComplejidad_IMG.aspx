<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EstudioAltaComplejidad_IMG.aspx.cs" Inherits="Impresiones_altaComplejidadIMG_EstudioAltaComplejidad" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\altaComplejidadIMG\EstudioAltaComplejidad_IMG.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_IMG_EstudiosAltaComplejidad_Imprimir" 
