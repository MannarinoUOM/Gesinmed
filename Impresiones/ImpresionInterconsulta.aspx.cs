...
public partial class Impresiones_ImpresionInterconsulta : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Interconsulta." + "PDF"));
