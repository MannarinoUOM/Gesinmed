<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reclamoImpresion.aspx.cs" Inherits="Impresiones_reclamos_reclamoImpresion" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\reclamos\reclamoImpresion.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Reclamo_Impresion" SelectCommandType="StoredProcedure">
            <SelectParameters>
