<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Autorizacion_Informe_Por_Rubro_Prestador.aspx.cs" Inherits="Impresiones_ReportesDYT_Autorizacion_Informe_Por_Rubro_Prestador" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesDYT\Autorizacion_Informe_Por_Rubro_Prestador.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Autorizacion_Informe_SubRubro_Prestador" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter Name="idBusqueda" QueryStringField="idBusqueda" 
                    Type="Int32" />
                <asp:QueryStringParameter Name="prestador" QueryStringField="prestador" 
                    Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
