...
public partial class Impresiones_ReportesFarmacia_listado_de_medicamentos_por_servicio : System.Web.UI.Page
{
    ...
    public void pdf()
    {
        if (Existe)
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=listadoDeMedicamentosPorServicio." + "PDF"));
