...
public partial class Impresiones_ReportesFarmacia_Articulos_de_Farmacia : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[3] = new ReportParameter("rubro", Request.QueryString["rubro"]);
            parameters[4] = new ReportParameter("presentacion", Request.QueryString["presentacion"]);
            parameters[5] = new ReportParameter("insumo", Request.QueryString["insumo"]);
            parameters[6] = new ReportParameter("medidaDescripcion", Request.QueryString["medidaDescripcion"]);
    ...
    public void pdf()
    {
        if (Existe)
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Articulos_de_Farmacia." + "PDF"));
