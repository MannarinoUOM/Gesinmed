<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionLiquidacionAmbu_Inter.aspx.cs" Inherits="Impresiones_ImpresionLiquidacionAmbu_Inter" %>
    ...
    <div>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <localreport reportpath="Impresiones\ImpresionLiquidacionAmbu_inter.rdlc">
                <datasources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_FACT_LIQUIDACION_AMBU_INT_SN" 
