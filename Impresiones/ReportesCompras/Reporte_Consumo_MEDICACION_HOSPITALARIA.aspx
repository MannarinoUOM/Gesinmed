<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reporte_Consumo_MEDICACION_HOSPITALARIA.aspx.cs" Inherits="Impresiones_ReportesCompras_Reporte_Consumo_MEDICACION_HOSPITALARIA" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesCompras\Reporte_Consumo_MEDICACION_HOSPITALARIA.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Reporte_Consumo_MEDICACION_HOSPITALARIA" 
