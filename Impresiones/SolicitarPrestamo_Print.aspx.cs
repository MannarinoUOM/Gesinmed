...
public partial class Impresiones_SolicitarPrestamo_Print : System.Web.UI.Page
{
    ...
    public void Crearpdf()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Solicitar_Prestamo." + Request.QueryString["DevolucionId"].ToString() + "PDF"));
