<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Diabetes_Impresion_Fichas.aspx.cs" Inherits="Impresiones_Diabetes_Impresion_Fichas" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Diabetes_Impresion_Fichas.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Diabetes_Todas_Fichas_Dos" 
