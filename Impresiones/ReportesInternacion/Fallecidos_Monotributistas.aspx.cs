...
public partial class Impresiones_ReportesInternacion_Fallecidos_Monotributistas : System.Web.UI.Page
{
    ...
    public void pdf()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Fallecidos_Monotributistas." + "PDF"));
