...
public partial class Impresiones_ReportesInternacion_Egresos_Monotributistas : System.Web.UI.Page
{
    ...
    public void pdf()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Egresos_Monotributistas." + "PDF"));
