...
public partial class Impresiones_ReportesInternacion_Ingresos_Monotributistas : System.Web.UI.Page
{
    ...
    public void pdf()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Ingresos_Monotributistas." + "PDF"));
