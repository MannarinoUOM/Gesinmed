...
public partial class Impresiones_Patologia_H2_Pato_Listado_Estudios_Realizados_X_Seccional_X_Servicio : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[5] = new ReportParameter("tipo", Request.QueryString["tipo"]);
    ...
    public void pdf()
    {
        if (Existe)
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Patologia_Listado_Estudios_Realizados_X_Seccional_X_Servicio." + "PDF"));
