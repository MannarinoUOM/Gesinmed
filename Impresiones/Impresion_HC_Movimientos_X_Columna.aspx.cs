...
public partial class Impresiones_Impresion_HC_Movimientos_X_Columna : System.Web.UI.Page
{
    ...
    public void PDF(object sender, EventArgs e)
    {
        Warning[] warnings;
        string[] streamids;
        string mimeType;
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=HC_Movimientos_X_Columna." + "PDF"));
