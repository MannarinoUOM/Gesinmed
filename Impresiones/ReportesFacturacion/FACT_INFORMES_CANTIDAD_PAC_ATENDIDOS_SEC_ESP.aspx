<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FACT_INFORMES_CANTIDAD_PAC_ATENDIDOS_SEC_ESP.aspx.cs" Inherits="Impresiones_ReportesFacturacion_FACT_INFORMES_CANTIDAD_PAC_ATENDIDOS_SEC_ESP" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesFacturacion\FACT_INFORMES_CANTIDAD_PAC_ATENDIDOS_SEC_ESP.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_FACT_INFORMES_CANTIDAD_PAC_ATENDIDOS_SEC_ESP" 
    ...
    <%if (Request.QueryString["PDF"].Equals("1")) %>
    <%pdf_Click(null, null); %>
</body>
</html>
