<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FACT_INFORMES_FACTURACION_AMBULATORIA_SECCIONAL.aspx.cs" Inherits="Impresiones_ReportesFacturacion_FACT_INFORMES_FACTURACION_AMBULATORIA_SECCIONAL" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesFacturacion\FACT_INFORMES_FACTURACION_AMBULATORIA_SECCIONAL.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="FuenteDatos" Name="DataSet3" />
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_FACT_REPORTES_RENDICION_SEC_FECHA" 
