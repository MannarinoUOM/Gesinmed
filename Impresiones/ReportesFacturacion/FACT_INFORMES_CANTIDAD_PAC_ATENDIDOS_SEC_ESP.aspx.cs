...
public partial class Impresiones_ReportesFacturacion_FACT_INFORMES_CANTIDAD_PAC_ATENDIDOS_SEC_ESP : System.Web.UI.Page
{
    ...
    public void pdf_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=ReportesFacturacion_Cant_Pac_Sec_Esp" + DateTime.Now.ToShortDateString() + ".PDF"));
