<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevolucionporPrestamo_Print.aspx.cs" Inherits="Impresiones_DevolucionporPrestamo_Print" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\DevolucionporPrestamo_Print.rdlc" EnableExternalImages="True">
                <DataSources>
    ...
    <asp:SqlDataSource ID="FuenteCab" runat="server" 
        ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
        SelectCommand="H2_FAR_DEVOLUCION_PRESTAMO_CAB_PRINT" 
    ...
    <asp:SqlDataSource ID="FuenteDet" runat="server" 
        ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
        SelectCommand="H2_FAR_DEVOLUCION_PRESTAMO_DET_PRINT" 
        SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:QueryStringParameter Name="Pedido_Id" QueryStringField="DevolucionId" 
                Type="Int32" />
