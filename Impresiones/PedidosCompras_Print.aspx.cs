...
public partial class Impresiones_PedidosCompras_Print : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=PedidosCompras_" + Request.QueryString["PED_ID"].ToString() + ".PDF"));
