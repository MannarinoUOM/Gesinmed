...
public partial class Impresiones_ReportesHemodinamia_HemodinamiaTurnoVaucher : System.Web.UI.Page
{
    ...
    public void pdf()
    {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=TurnoQuirurgicoVaucher." + "PDF"));
