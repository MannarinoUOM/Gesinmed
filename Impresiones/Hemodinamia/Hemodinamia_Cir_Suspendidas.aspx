<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hemodinamia_Cir_Suspendidas.aspx.cs" Inherits="Hemodinamia_Cir_Suspendidas" %>
...
<body>    
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Hemodinamia\Hemodinamia_Cir_Suspendidas.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Fuente_Suspendidas" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Hemodinamia_Suspendida_Impresion" 
