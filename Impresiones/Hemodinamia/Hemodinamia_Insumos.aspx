<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hemodinamia_Insumos.aspx.cs" Inherits="Impresion_Hemodinamia_Insumos" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Hemodinamia\Hemodinamia_Impresion_Insumo.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Cabecera" runat="server" 
            ...
            SelectCommand="H2_HEMODINAMIA_INSUMO_IMPRESION_CABECERA" 
        ...
        <asp:SqlDataSource ID="DetalleDAL" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_HEMODINAMIA_INSUMOS_IMPRESION_DETALLE" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
