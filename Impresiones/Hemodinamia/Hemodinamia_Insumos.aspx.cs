...
public partial class Impresion_Hemodinamia_Insumos : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Insumos_Hemodinamia." + "PDF"));
