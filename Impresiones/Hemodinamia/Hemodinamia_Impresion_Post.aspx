<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hemodinamia_Impresion_Post.aspx.cs" Inherits="Impresion_Hemodinamia_Impresion_Post" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Hemodinamia\Hemodinamia_Impresion_Post.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="General" runat="server" 
            ...
            SelectCommand="H2_HEMODINAMIA_POST_CABECERA_CARGAR" 
        ...
        <asp:SqlDataSource ID="Monitoreo" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_HEMODINAMIA_POST_CABECERA_DETALLE_MONITOREO_CARGAR" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="CIRUGIA_ID" QueryStringField="Cirugia_Id" 
                    Type="Int64" />
        ...
        <asp:SqlDataSource ID="SignosVitales" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_HEMODINAMIA_POST_CABECERA_DETALLE_CONTROL_SIGNOS_VITALES_CARGAR" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="CIRUGIA_ID" QueryStringField="Cirugia_Id" 
                    Type="Int64" />
        ...
        <asp:SqlDataSource ID="Insumos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_HEMODINAMIA_POST_IMPRESION_INSUMOS" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="Cirugia_Id" QueryStringField="Cirugia_Id" 
                    Type="Int64" />
        ...
        <asp:SqlDataSource ID="Encabezado" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_HEMODINAMIA_POST_IMPRESION_ENCABEZADO" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="Cirugia_Id" QueryStringField="Cirugia_Id" 
                    Type="Int64" />
