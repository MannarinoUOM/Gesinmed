...
public partial class Impresiones_IQB_ImpresionIngreso : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=IQB_Ingreso." + "PDF"));
