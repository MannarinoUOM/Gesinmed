...
public partial class Impresiones_ReportesBonos_Listado_Bonos_Reporte_De_Bonos_Emitidos_Por_Terminal_Detallado : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[2] = new ReportParameter("especialidad", Request.QueryString["especialidad"]);
