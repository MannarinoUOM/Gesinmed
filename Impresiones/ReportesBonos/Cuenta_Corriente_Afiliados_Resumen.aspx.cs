...
public partial class Impresiones_ReportesBonos_Cuenta_Corriente_Afiliados_Resumen : System.Web.UI.Page
{
    ...
    public void pdf()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=CuentaCorrienteResumen." + "PDF"));
