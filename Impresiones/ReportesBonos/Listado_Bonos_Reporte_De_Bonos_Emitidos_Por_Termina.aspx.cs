...
public partial class Impresiones_ReportesBonos_Listado_Bonos_Reporte_De_Bonos_Emitidos_Por_Termina : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[3] = new ReportParameter("totales", Request.QueryString["totales"]);
    ...
    public void pdf()
    {
        ...
        try
        {
            ...
            Response.Redirect("../ErrorImpresion.aspx?E=1");
        }
    }
}