...
public partial class Impresiones_ReportesBonos_Turnos_monotributistas : System.Web.UI.Page
{
    ...
    public void pdf()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Turnos_monotributistas." + "PDF"));
