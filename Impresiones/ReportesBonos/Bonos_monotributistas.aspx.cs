...
public partial class Impresiones_ReportesBonos_Bonos_monotributistas : System.Web.UI.Page
{
    ...
    public void pdf()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Bonos_Monotributistas." + "PDF"));
