<%@ Page Language="C#" AutoEventWireup="true" CodeFile="H2_Reporte_IMG_Ecografias_Mensual_Servicio_Practica_Detallado.aspx.cs" Inherits="Impresiones_ReportesImagenes_H2_Reporte_IMG_Ecografias_Mensual_Servicio_Practica_Detallado" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesImagenes\H2_Reporte_IMG_Ecografias_Mensual_Servicio_Practica_Detallado.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Reporte_IMG_Ecografias_Mensual_Servicio_Practica_Detallado" 
