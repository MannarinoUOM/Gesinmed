...
public partial class Impresiones_At_Internados_IntraHosp : System.Web.UI.Page
{
    ...
    public void pdf_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=At_Internados_IntraHosp_" + DateTime.Now.ToShortDateString() + ".PDF"));
