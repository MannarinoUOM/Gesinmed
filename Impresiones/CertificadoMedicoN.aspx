<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertificadoMedicoN.aspx.cs" Inherits="Impresiones_CertificadoMedicoN" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\CertificadoMedicoN.rdlc" EnableExternalImages="true">
                <DataSources>
