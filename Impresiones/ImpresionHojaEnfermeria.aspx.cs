...
public partial class Impresiones_ImpresionHojaEnfermeria : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=HojadeEnfermeria." + "PDF"));
