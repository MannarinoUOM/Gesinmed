...
public partial class Impresiones_DevolucionporPrestamo_Print : System.Web.UI.Page
{
    ...
    public void Crearpdf()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Devolucion_Prestamo." + Request.QueryString["DevolucionId"].ToString() + "PDF"));
