<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TurneraBonosDos.aspx.cs" Inherits="Turnera_TurneraBonosDos" %>
...
<div class="Pie">
    <div class="Media">
<%--<iframe src="http://www.youtube.com/embed/Xz2cJ_9-QiE?rel=0&wmode=opaque&autoplay=1&loop=1" frameborder="0" allowfullscreen></iframe>--%>
</div>
...
<script src="../js/Hospitales/Llamador/TurneraBonosDos.js" type="text/javascript"></script>
...
//    });
    ...
    function Refrescar_Pantalla() {
        ...
        if (hh >= 22 && hh < 23) {
            if (mm >= 00 && mm <= 59) {
                window.location.href = 'http://10.10.8.71/Turnera/TurneraBonosDos.aspx';
            }
        }
    }
