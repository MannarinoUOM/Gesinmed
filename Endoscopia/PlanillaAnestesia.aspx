<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanillaAnestesia.aspx.cs" Inherits="Endoscopia_PlanillaAnestesia" %>
...
<input id="afiliadoId" value="" type="hidden" />
    ...
    <label style="display:inline; margin-left:1%" ><b>Ayudante </b></label><select class="medico" id="txtAyudante" style="width:834px"></select>
    </div>
    <%------------------PERSONALES-----------------%>
  ...
  <div style="width:98%; margin-left:2%"><%--border: 1px solid #CED5D8; --%>
  <table style="width:98%">
  <tr>
  <td style="width:20%">ASA: <label id="valorAsa" style="display:inline; font-weight:bold" >0</label><br /><div id="slider" style="width:200px"></div></td>
  <td style="width:20%"><label style="display:inline;" for="CheckProtesis">Protesis dentarias</label> <input type="checkbox" style="margin-top:0px" id="CheckProtesis"/></td>
  <td style="width:20%"><label style="display:inline;" for="CheckLentes">Lentes contacto</label> <input type="checkbox" style="margin-top:0px" id="CheckLentes"/></td>
  <td style="width:40%" colspan="2"><label style="display:inline;" for="CheckProteccion">Protección ocular y de cubitos</label> <input type="checkbox" style="margin-top:0px" id="CheckProteccion"/></td>
  </tr>
  <tr>
  <td ><b>ANESTESIA: </b><label style="display:inline;" for="CheckGral">GRAL</label> <input type="checkbox" style="margin-top:0px" id="CheckGral"/></td>
  <td ><label style="display:inline;" for="CheckNla">NLA</label> <input type="checkbox" style="margin-top:0px" id="CheckNla"/></td>
  <td ><label style="display:inline;" for="CheckRegional">REGIONAL</label> <input type="checkbox" style="margin-top:0px" id="CheckRegional"/></td>
  <td ><label style="display:inline;" for="CheckIntub">INTUB. TRAQ</label> <input type="checkbox" style="margin-top:0px" id="CheckIntub"/></td>
  <td ><label style="display:inline;" for="CheckMasc">MASC. LARING</label> <input type="checkbox" style="margin-top:0px" id="CheckMasc"/></td>
  </tr>
  <tr>
  ...
  <td>Tecnica anestesica </td><td colspan="4"><input type="text" id="txtTecnica" style="width:700px" /></td>
    ...
    <span style="background-color:#FF5733; cursor:pointer" class="tipo" data-tipo="." ><b>. Punto</b></span>
    <span style="background-color:#FFFB33; cursor:pointer" class="tipo" data-tipo="-" ><b>- Guion</b></span>
    <span style="background-color:#33FF76; cursor:pointer" class="tipo" data-tipo="v" ><b>v Tilde</b></span>
    <span style="background-color:#33CCFF; cursor:pointer" class="tipo" data-tipo="x" ><b>x Equis</b></span>
    <span style="background-color:#F3A9F1; cursor:pointer" class="tipo" data-tipo="^" ><b>^ Triangulo</b></span>
    <span style="background-color:transparent; cursor:pointer" class="tipo" data-tipo="" ><b>  Borrar</b></span>
    </div>
    <%------------------GRILLA-----------------%>
...
<script src="../js/Hospitales/Endoscopia/anestesia.js" type="text/javascript"></script>
