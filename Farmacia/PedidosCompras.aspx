<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PedidosCompras.aspx.cs" Inherits="Farmacia_PedidosCompras" %>
          ...
          <div class="contenedor_4 pagination-centered" style="height:60px;">
            ...
            <div class="combos" style="margin-left:10px; display:none;">
             ...
             <div class="combos" style="margin-left:10px;">
                    ...
                    <input type="text" id="cbo_Medicamento" data-provide="typeahead" autocomplete="off" style="width:255px;margin-top:-5px;" />
             </div>
          ...
          <div class="contenedor_4 pagination-centered" style="height:60px;">
              <form id="frm_Cantidad" class="form-inline" style="margin:10px 25px 0px 25px;">
                    ...
                    <input id="txt_Medicamento" name="txt_Medicamento" value="0" type="hidden" />
                       <div id="controlcantidad" class="control-group" style="display:inline;"><label for="cantidad">Cantidad: </label><input type="text" id="cantidad" name="cantidad" style="margin-top:-5px; width:40px;" class="input-mini numero" maxlength="3" /></div>
...
<div class="pull-right" style="padding:5px; height:120px; margin-top:-5px;">
  <a href="PedidosCompras_Buscar.aspx" class="btn"><i class=" icon-arrow-left"></i>&nbsp;Volver</a>
...
<script src="../js/Hospitales/Farmacia/PedidoCompras.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong>Pedido a Compras</strong>";
