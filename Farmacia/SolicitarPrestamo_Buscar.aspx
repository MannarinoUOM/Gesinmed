<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SolicitarPrestamo_Buscar.aspx.cs" Inherits="Farmacia_SolicitarPrestamo_Buscar" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:530px;"> <div class="titulo_seccion" id="titulo_bono">
      <span>Buscar Egreso por Prestamo</span></div>
        ...
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:120px;">
              ...
              <div id="controltxtNroPed" class="control-group" style="margin:0px 25px 0px 25px;">
                    <label for="txtNroPed" style="display:inline; margin-top:10px;">Nro de Egreso: </label>
...
<div class="pie_gris">
    <div class="pull-right" style="padding:5px; height:90px; margin-top:-5px;">
        ...
        <button id = "btnCargar" class="btn btn-warning"><i class=" icon-ok icon-white"></i>&nbsp;Cargar Egreso</button>
    </div>
</div>
      </div>
    </div>
...
<script src="../js/Hospitales/Farmacia/SolicitarPrestamo_Buscar.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong> Egreso por Prestamo > Buscar Egreso por Prestamo</strong>";
</script> 
</body>
</html>
