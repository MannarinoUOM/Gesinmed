<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SolicitarPrestamo.aspx.cs" Inherits="Farmacia_SolicitarPrestamo" %>
...
<div class="container" style="padding-top:30px;">
  ...
  <div id="cargando2" style="text-align:center; display:none;">
    ...
    <div id="cont_datospac" class="contenedor_2"> <div class="titulo_seccion">
      <img src="../img/1.jpg"/>&nbsp;&nbsp;<span>Egreso por Prestamo</span></div>
      ...
      <div class="control-group" style="display:none;">
         ...
         <div class="control-group">
          <label class="control-label" for="txtDevuelve">Detalle</label>
          <div class="controls">
            <textarea id="txtDevuelve" class="input-xlarge" rows="2" cols="50"></textarea>
      ...
      <div class="control-group">
          <div class="controls pagination-centered"> 
                ...
                <a id="btnPedidos" class="btn btn-warning">Buscar Egresos</a>  
          </div>
        </div>
    </div>
    <div class="clearfix"></div>
    <div id="hastaaqui">
      <div class="resumen_datos" style="height:80px;">
        ...
        <div>Nro. Egreso: <strong><span id="CargadoPedido">Provisorio</span></strong></div>
          ...
          <div>Detalle: <strong><span id="CargadoServicio"></span></strong>&nbsp;&nbsp;&nbsp;</div>
        </div>
      ...
      <div class="contenedor_3" style="height:410px;"> 
       <div class="">
          <div class="contenedor_4 pagination-centered" style="height:90px;">
             <div class="combos" style="margin-left:10px;">
                <label for="cbo_Medicamento" style="display:inline;width:56px;" class="span1">Insumo:</label>
                    <input type="text" id="cbo_Medicamento" data-provide="typeahead" autocomplete="off" style="width:250px;margin-top:-5px;" />
             </div>

                          <div class="combos" style="margin-left:0px;">
                <label for="cboLote" style="display:inline;width:88px; margin-left:1px" class="span1">Nro. de Lote:</label>
                    <select  id="cboLote" style="width:260px;margin-top:-5px;" ></select>
             </div>
          </div>
          <div class="contenedor_4 pagination-centered" style="height:50px;">
              <form id="frm_Cantidad" class="form-inline" style="margin:10px 25px 0px 25px;">
                        ...
                        <div id="controlcantidad" class="control-group" style="display:inline;">
                            ...
                            <input type="text" id="cantidad" name="cantidad" style="margin-top:-5px; width:40px;" class="input-mini numero" maxlength="3" />
                        ...
                        <label for="stock_minimo" style="display:none;">Stock Minimo: </label><div id="stock_minimo" style="display:inline;display:none;"></div>
              </form>
              <div class="clearfix"></div>
          </div>
          <div class="clearfix"></div>
        ...
        <div style="padding:0px 15px 0px 15px;">
            ...
            <div id="TablaMedicamentos" class="tabla" style="height:280px;width:100%;">
...
<script src="../js/Hospitales/Farmacia/SolicitarPrestamo.js" type="text/javascript"></script>
<script src="../js/General.js" type="text/javascript"></script>
<script src="../js/ui-datepicker-es.js" type="text/javascript"></script>
<!--Barra sup--> 
<script type="text/javascript">
    $('#desdeaqui').click(function () {
        if ($("#txtDevuelve").val().trim().length == 0) { alert("Ingrese quien solicita el egreso."); return false; }
        ...
        $("#CargadoServicio").html($("#txtDevuelve").val().trim());
    });
    parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong>Egreso por Préstamo</strong>";
</script> 
</body>
</html>
