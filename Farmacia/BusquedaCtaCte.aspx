      ...
      <form id="frm_Main" name="frm_Main">
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:150px;">
               ...
               <div id="controldesde" class="control-group fecha" style="margin:10px 0px 10px 0px;">
               ...
               <div id="controlhasta" class="control-group fecha" style="margin:10px 0px 10px 0px;">
               ...
               <input type="text" id="hasta" name="hasta" class="input-small"/></div>
                <div id="controlchkExcel" class="control-group" style="margin:10px 0px 10px 0px;">
               <span class="span1" style="width:110px;"> <label for="chkExcel" style="display:inline;">Exportar a Excel: </label></span>
               <input type="checkbox" id="chkExcel" name="chkExcel"/></div>
