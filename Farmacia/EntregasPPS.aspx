<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EntregasPPS.aspx.cs" Inherits="Farmacia_EntregasPPS" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:520px;"> <div class="titulo_seccion" id="titulo_bono">
      <span>Entregas por Servicio</span></div>
        ...
        <div class="">
          ...
          <div class="clearfix"></div>
                 <div style="display:block; margin-left:20px;">
                            ...
                            <div id="btn_Paciales" class="reff Turnos_Sobreturno">Parciales</div>
...
<script src="../js/Hospitales/Farmacia/Buscar_PPS_ENT.js" type="text/javascript"></script>    
