   ...
   <div class="contenedor_3" style="height:530px;width:970px;"> <div class="titulo_seccion" id="titulo_bono">
      <span>Buscar Insumos</span></div>
          ...
          <div class="contenedor_4 pagination-centered" style="height:110px;">
               <div id="controlmedicamento" class="control-group" style="display:inline; margin:10px 10px 0px 10px;"><label for="medicamento" style="display:inline;">Insumo: </label><input type="text" id="medicamento" name="medicamento" maxlength="30" class="input-xlarge" style="margin-top:10px;" /></div>
               <div id="Div1" class="control-group" style="display:inline; margin:10px 10px 0px 10px;"><label for="cboMedida" style="display:inline;">Medida: </label><select type="text" id="cboMedida" name="medida" maxlength="30" class="input-xlarge" style="margin-top:10px;"></select></div>
          </div>
...
<a id = "btnAlta" class="btn btn-warning"><i class="icon-ok icon-white"></i>&nbsp;Alta Insumo</a>
</div>
</div>
      </div>
    </div>
