<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevolucionporPrestamo.aspx.cs" Inherits="Farmacia_DevolucionporPrestamo" %>
...
<div class="container" style="padding-top:30px;">
  ...
  <div id="cargando2" style="text-align:center; display:none;">
    ...
    <div id="cont_datospac" class="contenedor_2"> <div class="titulo_seccion">
      <img src="../img/1.jpg"/>&nbsp;&nbsp;<span>Ingreso por Prestamo</span></div>
      ...
      <div class="control-group">
          <div class="controls pagination-centered"> 
                ...
                <a id="btnPedidos" class="btn btn-warning">Buscar Ingresos</a>  
          </div>
        </div>
    </div>
    <div class="clearfix"></div>
    <div id="hastaaqui">
      <div class="resumen_datos" style="height:80px;">
        ...
        <div>Nro. Ingreso: <strong><span id="CargadoPedido">Provisorio</span></strong></div>
          ...
          <div class="contenedor_4 pagination-centered" style="height:90px;">
             <div class="combos" style="margin-left:10px;">
                <label for="cbo_Medicamento" style="display:inline;width:56px;" class="span1">Insumo:</label>
                    <input type="text" id="cbo_Medicamento" data-provide="typeahead" autocomplete="off" style="width:250px;margin-top:-5px; margin-left:12px" />
             </div>
                                       <div class="combos" style="margin-left:10px;">
...
<script src="../js/Hospitales/Farmacia/DevolucionporPrestamo.js" type="text/javascript"></script>
<script src="../js/General.js" type="text/javascript"></script>
<script src="../js/ui-datepicker-es.js" type="text/javascript"></script>
<!--Barra sup--> 
<script type="text/javascript">
    $('#desdeaqui').click(function () {
        if ($("#txtDevuelve").val().trim().length == 0) { alert("Ingrese quien realiza el Ingreso."); return false; }
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong>Ingreso por Prestamo</strong>";
</script> 
</body>
</html>
