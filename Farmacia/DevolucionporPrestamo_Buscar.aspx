<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevolucionporPrestamo_Buscar.aspx.cs" Inherits="Farmacia_DevolucionporPrestamo_Buscar" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:530px;"> <div class="titulo_seccion" id="titulo_bono">
      <span>Buscar Ingreso por Prestamo</span></div>
      <form id="frm_Main" name="frm_Main">
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:120px;">
              ...
              <div id="controltxtNroPed" class="control-group" style="margin:0px 25px 0px 25px;">
                    <label for="txtNroPed" style="display:inline; margin-top:10px;">Nro de Ingreso: </label>
                    <input type="text" id="txtNroPed" name="txtNroPed" placeholder="Ingrese Nro." class="input-medium" style="margin-top:10px;" />
              </div>
        ...
        <div style="padding:0px 15px 0px 15px;">
            ...
            <div id="TablaPedidos_div" class="tabla" style="height:350px;width:100%; margin-top:0px;">
...
<div class="pie_gris">
    <div class="pull-right" style="padding:5px; height:90px; margin-top:-5px;">
        ...
        <button id = "btnCargar" class="btn btn-warning"><i class=" icon-ok icon-white"></i>&nbsp;Cargar Ingreso</button>
    </div>
</div>
      </div>
    </div>
...
<script src="../js/Hospitales/Farmacia/DevolucionporPrestamo_Buscar.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong> Ingresos por Prestamo > Buscar Ingresos por Prestamo</strong>";
</script> 
</body>
</html>
