...
<body>
    ...
    <div>
     <div id="Primero" style="display:none; height:600">
          ...
          <div class="container" style="padding-top: 30px; height: 650px; width:100%; margin-left:33px">
           
        <div class="contenedor_1" style="height:517px; margin-top:10px; width:1500px">

            <div class="contenedor_3" style="height:500px; padding-bottom:0px; width:1351px; margin-left:5%">
                <div class="titulo_seccion" style="margin-top: 5px; width:560px">
                 <span> Comidas de Internados<label id="tituloInternados" style="display:inline; margin-bottom:0px; margin-top:3px; font-size:large"></label></span>
                 <label id="subrayado" style="display:none">(<u>Cantidad de Internados:</u></label>
                </div>
                
            <div class="modal-backdrop" style="width:100%; height:25px; background-position:center; position:inherit; background-color:Black">
            <label class="check inline" style="width:1%; text-align:center"><strong style="color:White"></strong></label>
            <label class="check inline" style="width:14%; text-align:center"><strong style="color:White">Servicio</strong></label>
            <label class="check inline" style="width:14%; text-align:center"><strong style="color:White; text-align:center">Sala</strong></label>
            <label class="check inline" style="width:4%; text-align:center"><strong style="color:White">Cama</strong></label>
            <label class="check inline" style="width:4%; text-align:center"><strong style="color:White">NHC</strong></label>
            <label class="check inline" style="width:13%; text-align:center"><strong style="color:White">Afiliado</strong></label>
            <label class="check inline" style="width:10%; text-align:center"><strong style="color:White">Almuerzo</strong></label>
            <label class="check inline" style="width:10%; text-align:center"><strong style="color:White">Cena</strong></label>
            <label class="check inline" style="width:10%; text-align:center"><strong style="color:White">Acomp. Almuerzo</strong></label>
            <label class="check inline" style="width:10%; text-align:center"><strong style="color:White">Acomp. Cena</strong></label>
            <label class="check inline" style="width:7%; text-align:center"><strong style="color:White">Confirmar</strong></label>
            </div> 
...
<%--////////////////////////////SEGUNDO//////////////////////////////////////////////////////////--%>
        ...
        <label class="label" style="margin-left:0px; display:none">Comidas Pedidas de Acompañantes:</label>
           ...
           <label id="btnComidos"  style="margin-left:0px; background-color:#58FA58; width:350px; float:right">Comidas Pacientes() - Comidas Acompañantes() Comidas Pendientes()</label>
...
<%--    <p>Tenga en cuenta que...</p>
  ...
  <div class="modal-footer">
   ...
   <script src="../js/Hospitales/Nutricion/Listar_Totales_Dietas.js" type="text/javascript"></script>
