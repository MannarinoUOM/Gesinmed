<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MAPA.aspx.cs" Inherits="EstudiosComplementarios_MAPA" %>
            ...
            <div class="contenedor_3" style="padding: 0px; height: 100%">
                ...
                <div style="height: 400px">
                    ...
                    <div style="height: 20%; overflow: no">
                        <label id="lblMAPA" style="font-weight: bold; margin-left: 320px; display: inline">
                            Monitoreo Ambulatorio de Presion Arterial</label>
                        <br />
                        ...
                        <br />
                        <label id="lblInformeyConclusion" style="font-weight: bold; margin-left: 15px; display: inline">
                            Informe y Conclusión:</label>
                        <div id="divInformeyConclusion">
                            <textarea id="txtInformeyConclusion" style="width: 95%; height: 200px; margin: 15px"
                                placeholder="Ingrese Informe y Conclusion" maxlength="5000"></textarea>
                        </div>
                    </div>
                </div>
                <div class="pie_gris">
                    <a id="btnCerrar" class="btn btn-info pull-right">Cerrar</a> 
                    <a id="btnGuardarMAPA" class="btn btn-info pull-right">Guardar</a> 
                    <a id="btnImprimirMAPA" class="btn btn-info pull-right">Imprimir</a>
                </div>
            </div>
        </div>
    </div>
