...
public partial class Impresion_Pre_Anestesico : System.Web.UI.Page
{
    ...
    public void pdf()
    {
        //ReportViewer1.LocalReport.ReportPath = "Impresion/ConfirmacionTurnos.rdlc";
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Pre_Anestesico." + "PDF"));
