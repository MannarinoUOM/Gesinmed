<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Partes_Generados.aspx.cs" Inherits="Hemodinamia_Listar_Partes_Generados" %>
...
<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Hemodinamia > <strong>Partes de Hemodinamia</strong>";
</script> 
...
<script type="text/javascript">
    $(document).ready(function () {
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/TraerPartesQuirurgicosGeneradosHemodinamia",
