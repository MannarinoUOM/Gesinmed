<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListadoInsumosHemodinamia.aspx.cs" Inherits="Hemodinamia_ListadoInsumos" %>
...
<script src="../js/Hospitales/Hemodinamia/ListadoInsumos.js?v=2" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Hemodinamia > <strong>Insumos</strong>";
