<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Protocolosq.aspx.cs" Inherits="Hemodinamia_Protocolosq" %>
...
<script type="text/javascript" src="../js/bootstrap.js"></script> 
    <script src="../js/Hospitales/Hemodinamia/Protocolos.js" type="text/javascript"></script>  
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Hemodinamia > Turnos > Planificar Hemodinamia > <strong>Protocolos</strong>";
