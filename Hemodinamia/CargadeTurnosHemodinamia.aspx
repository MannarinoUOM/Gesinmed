<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CargadeTurnosHemodinamia.aspx.cs" Inherits="Quirofano_CargadeTurnos_Hemodinamia" %>
...
<style>
.Turnos_Ocupados {  background-color: #D7BDE2;}
.Turnos_Cancelado { background-color: #EC7063;}
.Turnos_Urgencias {background-color: #F7DC6F;}
.Turnos_Realizadas {background-color: #82E0AA;}
</style>
   ...
   <div class="contenedor_3" style="height:450px;"> <div class="titulo_seccion" id="titulo_bono">
      ...
      <form id="frm_Main" name="frm_Main">
        ...
        <div style="padding:0px 15px 0px 15px;">
            ...
            <div class="clearfix"></div>
            <div id="TablaCirugias" class="tabla" style="height:310px;width:100%; margin-top:10px; overflow:auto;">
...
<a id = "btnPlanificar" class="btn btn-info pull-right"><i class=" icon-ok icon-white"></i>&nbsp;Planificar Hemodinamia</a>
...
<script src="../js/Hospitales/Hemodinamia/CargadeTurnos.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Hemodinamia > <strong>Turnos</strong>";
