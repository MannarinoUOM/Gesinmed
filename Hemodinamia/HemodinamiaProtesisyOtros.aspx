<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HemodinamiaProtesisyOtros.aspx.cs" Inherits="Hemodinamia_Quirofano_ProtesisyOtros" %>
...
<div class="pull-right" style="padding:5px; height:120px;">
  ...
  <button id = "btnConfirmar" class="btn btn-info"><i class=" icon-ok icon-white"></i>&nbsp;Guardar</button>
  <button id = "btn_imprimir" class="btn btn-info"><i class=" icon-ok icon-white"></i>&nbsp;Imprimir</button>
</div>
</div>
      </div>
...
<script src="../js/Hospitales/Hemodinamia/ProtesisyOtros.js" type="text/javascript"></script>  
