<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HemodinamiaProtesisyOtros_CB.aspx.cs" Inherits="Hemodinamia_ProtesisyOtros_CB" %>
    ...
    <div class="contenedor_2" style="display:none;"> <div class="titulo_seccion">
      ...
      <div class="control-group">
          <div class="controls pagination-centered"> 
                <a class="btn btn-danger" href="Planificar-Hemodinamia.aspx" id="btnCancelarPedidoTurno" style="display:none;">Otro Paciente</a> 
...
<script src="../js/Hospitales/Hemodinamia/ProtesisyOtros_CB.js" type="text/javascript"></script>

<%
    Hospital.VerificadorBLL v = new Hospital.VerificadorBLL();
    if (v.PermisoSM("101")) { Response.Write("<script>var PermisoEliminar = true;</script>"); } else { Response.Write("<script>var PermisoEliminar = false;</script>"); }
%>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Hemodinamia > Turnos > Planificar Hemodinamia > <strong>Extras (Prótesis y Otros)</strong>";
