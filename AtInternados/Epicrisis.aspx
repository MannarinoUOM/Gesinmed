<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Epicrisis.aspx.cs" Inherits="AtInternados_Epicrisis" %>
...
<div class="container">
  <div class="contenedor_1">
    <div class="contenedor_a" style="position:relative;margin-left:15px; height:560px;">
      <div class="resumen_datos" style="height:90px; width:900px"> 
        <!--Datos del paciente-->
        ...
        <div class="datos_medico style=" width:100px">
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <input id="txtFechaEgreso" type="text" class="span2" maxlength="10" />
                            ...
                            <div class="control-group" id="ICD10">
                                <label class="control-label">1º Código ICD10</label>
                                <div class="controls">
                                    ...
                                    <input type="hidden" id="diag_nombre_pri" />
                                    <input type="hidden" id="id_val_pri" value="0"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">2º Código ICD10</label>
                                <div class="controls">
                                    ...
                                    <input type="hidden" id="diag_nombre_sec" />
                                    <input type="hidden" id="id_val_sec" value="0"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">3º Código ICD10</label>
                                <div class="controls">
                                    ...
                                    <input type="hidden" id="diag_nombre_ter" />
                                    <input type="hidden" id="id_val_ter" value="0"/>
                                </div>
                            </div>
<div class="control-group">
...
<script src="../js/Hospitales/AtInternados/Epicrisis.js" type="text/javascript"></script>
...
<script type='text/javascript'>
    ...
    //parent.document.getElementById("DondeEstoy").innerHTML = "At. Internados > Lista Pacientes internados > <strong>Epicrisis</strong>";
