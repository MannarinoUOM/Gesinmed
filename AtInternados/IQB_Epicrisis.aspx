<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IQB_Epicrisis.aspx.cs" Inherits="AtInternados_IQB_Epicrisis" %>
...
<div class="control-group">
              <label class="control-label">Diag. de Ingreso</label>
              <div class="controls">
                <textarea type="text" id="txt_MotivoInternacion" class="span8" rows="8"></textarea>
              </div>
            </div>
<div class="control-group">
              <label class="control-label">Cirugia Realizada</label>
              <div class="controls">
...
<script src="../js/Hospitales/AtInternados/IQB_Epicrisis.js" type="text/javascript"></script>
<!--Barra sup--> 
