<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cerrarReclamoAfiliaciones.aspx.cs" Inherits="ReclamoAfiliacion_cerrarReclamoAfiliaciones" %>
...
<div class="container">
  <div class="contenedor_1" >
    <div class="contenedor_a" style="position:relative;margin-left:5%;height:530px; width:90%">
      <h3>Cerrar Reclamo Afiliaciones</h3>
      ...
      <div class="pie_gris">
       ...
       <a id="btnVolver" class="btn btn-info pull-left" style="margin-left:30px" href="ReclamosAfiliacionesBusqueda.aspx"><i class=" icon-arrow-left"></i>&nbsp;&nbsp;Volver</a>
        </div>
      </div>
    ...
    <script src="../js/ui-datepicker-es.js" type="text/javascript"></script> 
    <script src="../js/Hospitales/ReclamosAfiliaciones/cerrarReclamoAfiliaciones.js" type="text/javascript"></script>


<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Informes > Informes Administrativos > <strong>Cerrar Reclamo Afiliaciones</strong>";
</script>  