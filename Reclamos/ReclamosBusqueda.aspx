<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReclamosBusqueda.aspx.cs" Inherits="Reclamos_ReclamosBusqueda" %>
...
<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Informes > Informes Administrativos > <strong>Buscar Reclamos</strong>";
</script>  
    ...
    <script src="../js/ui-datepicker-es.js" type="text/javascript"></script> 
    <script src="../js/Hospitales/reclamos/reclamosBusqueda.js" type="text/javascript"></script>
