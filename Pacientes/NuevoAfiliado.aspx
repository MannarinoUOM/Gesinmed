            ...
            <form class="form-horizontal">
             <div id="controlcboCodPariente" class="control-group">
              ...
              <div id="Div1" class="control-group">
                ...
                <div class="controls">
                  <input id="txtFechaBaja" maxlength="10" class="span2" type="text"7></div>
              </div>
            ...
            <form class="form-horizontal" >
             ...
             <div id="controlNacionalidad" class="control-group">
              ...
              <div class="span8" style="margin-top:0px;">
                  <label for="txtNroCarnet" class="control-label" style="display:inline; margin-right:50px;">Autorizado por:</label>
                  <input id="txtNroCarnet" maxlength="20" type="text" class="span6" style="display:inline; width:455px;"/>
              </div>
          <div class="clearfix"></div>
...
<form class="form-horizontal DP pull-left" style="margin-top:-14px;">
        ...
        <div class="tab-pane fade in" id="tab2">
          ...
          <div class="label_top_grupo">
              ...
              <div>Celular</div>
              <input id="txttelefono" maxlength="10" placeholder="Ej. 43625910" class="span2" type="text"/>
            </div>
          <div class="label_top">
              <div>celular adicional</div>
              <input id="txtcelular" maxlength="10" type="text" class="span3"/>
            </div>
          <div class="clearfix"></div>
          </div>
...
<%--              <label class="checkbox"><span>Alto Riesgo</span>
        ...
        <div class="tab-pane fade in" id="tab5">
             ...
             <a id="btnAdjuntar" class="btn btn-info" style="margin-top:0px; margin-left:10px; margin-bottom:10px;"><i class="icon-upload"></i>&nbsp;Adjuntar</a>

<%--             <asp:FileUpload ID="FileUpload1" runat="server" AllowMultiple="true"/>
             <asp:Button ID="Button1" runat="server" Text="Button" onclick="btnSubir_Click" style="display:none" UseSubmitBehavior="false"/>--%>
