        ...
        <div style="height: 600px; overflow: hidden;">
            <div style="height: 1000px;">
                <div class="contenedor_login">
                    ...
                    <div class="centrar1">
                        <input id="Usuario" type="text" placeholder="Usuario" style="" class="login_input" /></div>
                    <div class="centrar1">
                        <input id="Clave" type="password" placeholder="Contraseña" class="login_input" /></div>
...
<script type="text/javascript" language="javascript">
    ...
    function inicio(a) {
        a = a.d.split("="); switch (a[0]) {
            case "MIGUE": if ($("#Clave").val() == "1234") window.location = "Administracion/CambiarClave.aspx?Cambio=1"; else window.location = "migue.aspx"; break;
            //case "OK": if ($("#Clave").val() == "1234") window.location = "Administracion/CambiarClave.aspx?Cambio=1"; else window.location = "Inicio2.aspx"; break;  
            //----------prueba para nuevo login-------------------------------------- 
    ...
    /*-----------funcion para mostrar cartelito de olvido contraseña--------*/
    var clic = 1;
    function divAuto() {
        if (clic == 1) {
            document.getElementById("div-mostrar").style.height = "100px";
            document.getElementById("div-mostrar").style.opacity = "1";
            clic = clic + 1;
        } else {
            document.getElementById("div-mostrar").style.height = "0px";
            document.getElementById("div-mostrar").style.opacity = "0";
            clic = 1;
        }
    }
