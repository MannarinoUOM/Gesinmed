...
<body>
    ...
    <div id="ModalTraspasoProtocolo2" class="modal hide fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true" style="width:720px; height:400px; left:45%">
    ...
    <div id="panel" style=" width:700px; text-align:center; margin:auto; margin-top:0%; margin:1%; margin-right:2% ;position:relative">
    <div id="boca" style=" width:700px; text-align:center; background-color:Silver; margin:1%; margin-right:2%" class="contenedor_1">
    ...
    <div style=" height:80px; overflow:auto" class="table-responsive"><table id="carga"><tr style='background-color:#CCCCCC'>
    <th class='celdaMediana'>Código</th><th class='celdaChica' style="width:60px">Pieza</th><th class='celdaChica' style="width:60px">Caras</th><th class='celdaMediana'>Observación</th><th class='celdaChica' style="width:60px">Eliminar</th></tr></table></div>
    </div>
    <div style="width:700px;height:155px; margin:auto" class="contenedorAbajo">
    <div style=" height:180px; overflow:auto" id="consultas">
    <div>Consultas</div>
