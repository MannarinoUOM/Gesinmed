<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Solicitud_Cirugia_Programada.aspx.cs" Inherits="AtConsultorio_Solicitud_Cirugia_Programada" %>
...
<div><te>Cirujano:</te> <span id="CirujanoUsuario"></span>   Cirujano Externo: <select id="cbo_cirujano" style="width:180px;"><option value="0">Seleccione un médico externo.</option></select> <a class="btn btn-success" style="margin-bottom: 11px;" onclick="javascript:CargarMedico();">E</a>
</div>
...
<div class="d_flotante"><cp>Anatomía Patológica: </cp> 
...
<div class="d_flotante"><cp>Monitoreo: </cp>
...
<a id="btn_guardar" class="btn btn-success">Guardar</a> <a id="btn_cancelar" class="btn btn-danger">Cancelar</a> <a id="btn_reprogramar" class="btn btn-primary">Reprogramar</a>
    ...
    <script src="../js/Hospitales/AtConsultorio/Consulta_Cirugia_Programada.js" type="text/javascript"></script>
    <!--Barra sup-->
</body>
</html>
