<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReporteAdministracion.aspx.cs" Inherits="Compras_ReporteAdministracion" %>
            ...
            <div class="contenedor_4 pagination-centered" style="height:40px;">       
                        <div class="controls" style="margin-left:10px; margin-top:10px;">
                                    ...
                                    <form id="radios" style="display:inline;">
                                        <label class="radio-inline" style="position:fixed; margin-bottom:0px">
                                            <input id="rd_Todos" type="radio" name="optradio" value="0" checked style="margin-bottom:3px">Todos
                                        </label>
                                        <label class="radio-inline" style="position:fixed;left: 690px; margin-bottom:0px">
                                            <input id="rd_Entregados" type="radio" name="optradio" value="1">Ya Pedidos
                                        </label>
                                        <label class="radio-inline" style="position:fixed;left: 800px; margin-bottom:0px">
                                            <input id="rd_Pendientes" type="radio" name="optradio" value="2">Falta Pedir
                                        </label>
                                        <a id="btnBuscar" class="btn btn-danger" style="position:fixed;left: 990px;"><i class=" icon-search"></i>&nbsp;Buscar</a>
                                        <a style="margin-left:0px;margin-top:0px;position:fixed;left: 1080px;" class="btn btn-primary" id="lbl_CantidadReg">0</a>
                                    </form>
                        </div>                  
          </div>      
          </div>
...
<script src="../js/Hospitales/Compras/ReporteAdministracion.js" type="text/javascript"></script>
<script src="../js/General.js" type="text/javascript"></script>
<script src="../js/ui-datepicker-es.js" type="text/javascript"></script>
<!--Barra sup--> 
<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Compras > Administración > <strong>Reporte Administración</strong>";
</script> 
</body>
</html>
