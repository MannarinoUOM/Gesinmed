<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mostrar_Expedientes.aspx.cs" Inherits="Compras_Mostrar_Expedientes" %>
            ...
            <div id="hastaaqui" style="display: inline;">
                <div class="contenedor_3" style="height:450px">
                    <div class="">
                        ...
                        <div class="minicontenedor50" style="width:400px; margin-left:5px;">
                            ...
                            <div id="ControlFechas" class="controls control-group" style="margin-bottom: 0px;">
                                ...
                                <input id="txtVencimientoDesde" type="text" class="input-small date" style="margin-left:5px;">
                    ...
                    <div style="padding: 0px 15px 0px 15px;">
                        ...
                        <div id="TablaBonos" class="tabla" style="height:150px; width: 890px;">
...
<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Compras > Ambulatorio CABA > <strong>Buscar Expedientes</strong>";
</script> 
</body>
</html>
