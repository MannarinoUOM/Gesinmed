<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mostrar_Expedientes_Internacion.aspx.cs" Inherits="Compras_Mostrar_Expedientes_Internacion" %>
                    ...
                    <div class="">
                        ...
                        <div class="minicontenedor50" style="width:400px; margin-left:5px;">
                            <div class="controls">
                                ...
                                <input id="txtNroExpediente" type="text" class="input-mini numero verificar" style="margin-left:21px" maxlength="7"/>
                                <span for="cbo_Estado" style="margin-left:8px">Estado</span>
                                <select id="cbo_Estado" class="input-medium verificar" style="width: 158px;"></select>
                            </div>
                            <div class="controls">
                                <span for="txtPaciente">Paciente</span>
                                <input id="txtPaciente" type="text" class="input-xlarge verificar" style="margin-left:35px; width:279px" maxlength="40"/>
                            </div>
                            <div class="controls">
                                <span for="cbo_Discapacidad">Discapacidad</span>
                                <select id="cbo_Discapacidad" class="input-xlarge verificar" style="width: 294px; margin-left:5px"></select>
                            </div>
                            <div class="controls">
                                <span for="txtNroPedido">Nro. Pedido</span>
                                <input id="txtNroPedido" type="text" class="input-small numero verificar" style="margin-left:16px" maxlength="10">
                                <span for="txtNroDoc" style="margin-left:6px">Nro. Doc.</span>
                                <input id="txtNroDoc" type="text" class="input-small numero verificar" style="margin-left: 15px;" maxlength="8">
                            </div>
                            <div id="ControlFechas" class="controls control-group" style="margin-bottom: 0px;">
                                <span for="txtVencimientoDesde">Fecha Desde</span>
                                <input id="txtVencimientoDesde" type="text" class="input-small date verificar" style="margin-left:5px;">
                                <span for="txtVencimientoHasta" style="margin-left:2px">Fecha Hasta</span>
                                <input id="txtVencimientoHasta" type="text" class="input-small date verificar">
                            </div>
                        </div>
...
<%--                            <span style="width:100px;">Con Casam. o Nac.</span> <input type="checkbox" id="chkDocu_CasaNam" style="margin-top:0px; margin-right:15px;"/>
                            ...
                            <button style="margin-right:30px;" type="button" class="btn btn-primary pull-right" id="lbl_CantidadReg">0</button>
                        </div>
...
<script src="../js/jquery.maskedinput-1.3.js" type="text/javascript"></script>
    <script src="../js/Hospitales/Compras/Mostrar_Expedientes_Internacion.js" type="text/javascript"></script>
