<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Compras_InformeGlobal_Internacion.aspx.cs" Inherits="Compras_Compras_InformeGlobal_Internacion" %>
...
<script src="../js/Hospitales/Compras/Compras_InformeGlobal_Internacion.js" type="text/javascript"></script>
<script src="../js/General.js" type="text/javascript"></script>
<script src="../js/ui-datepicker-es.js" type="text/javascript"></script>
<!--Barra sup--> 
<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Compras > Internación > <strong>Control de Entregas</strong>";
</script> 
</body>
</html>