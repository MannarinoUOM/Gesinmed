<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Compras_Entregas_NEW_Internacion.aspx.cs" Inherits="Compras_Compras_Entregas_NEW_Internacion" %>
          ...
          <input type="hidden" id="Cod_OS" />
            ...
            <div id="hastaaqui" style="width:1250px; z-index:-1; position:static">--%>
                    ...
                    <div class="datos_paciente" style="height:95px; font-size:12px; width:100%">
                        ...
                        <div class="datos_resumen_paciente" style="height:95px;">
                            <div>
                                ...
                                &nbsp;&nbsp;&nbsp;<span>Vto. Expte.: <strong><span id="CargadoVtoExpte"></span></strong>
                            </span></div><div>Paciente: <strong><span id="CargadoApellido"></span></strong><a href="javascript:VerMas();" class="ver_mas_datos">Ver más</a></div>
                ...
                <%-- %><div id="contCAB" class="contenedor_3" style="height:320px; margin-bottom:10px; width:1222px; position:relative; z-index:1">
                    ...
                    <div class="span3" style="width:120px;">Servicio<select id="cboArea" class="datoCAB bloquear" style="width:170%" disabled=disabled></select></div>
                    ...
                    <div class="span3" style="width:120px; margin-left:0px">Médico<select id="cboMedico" class="datoCAB bloquear"  style="width:170%" disabled=disabled></select></div>
                    <div class="span3" style="width:200px; margin-bottom:40px">Fecha de Intervención<br />
                    <%--<button id="EXP_PED_FEC_AUTORIZ" type="button" class="btn btn-default datoCAB  dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"></button>--%>
<%--                    <div class="btn-group dropup" style="z-index:2000; position:fixed">
                     <input id="btnFechaCirugia" class="bloquear input-small" type="text" disabled=disabled/>
...
<%--                    <div class="span3" style="width:120px;">
                    ...
                    <div class="span3" style="width:200px;">Fecha de prescripción médica<input id="EXP_PED_FECHA_RECETA" type="text" class="input-small date datoCAB bloquear" disabled=disabled/></div>
                    ...
                    <div class="span3 pull-right" style="width:280px; margin-right:25px; display:none">
                        ...
                        <a id="btnEliminarCAB" class="btn btn-mini btn-danger">Eliminar</a>
                         ...
                         <a id="btnEntregas" class="btn btn-mini" style="display:none">&nbsp;Entregas</a>
                ...
                </div>//////////////////////////////agjhxfjlkghañsdfjlkg--%>
                <div class="clearfix">
                </div>
                <div id="contDET" class="contenedor_3" style="height:370px; width:1220px; margin-top:1%; margin-left:20px">
                    <div id="pSala">
                    </div>
                    <!--Tabla de detalles-->
                    <div style="padding: 0px 15px 0px 15px;">
        ...
        <%--                    <form class="form-inline">
                    ...
                    <div class="pie_gris">
                        <div class="pull-right">     
                        <label style="cursor:default; background-color:Yellow; margin-right:20px; margin-bottom:0px; display:inline-block;border-radius:10px; height:23px; width:180px; text-align:center;font-weight:bold">Entregado</label>   
                            <a id="btnVerCAB" class="btn">Ver Pedidos</a>
                            <a id="btnImprimir" class="btn btn-mini btn-success"><i class="icon-print icon-white"></i>&nbsp;Imprimir</a>     
...
<script src="../js/Hospitales/Compras/Compras_Entregas_NEW_Internacion.js" type="text/javascript"></script>
<script src="../js/Hospitales/Recurrentes.js" type="text/javascript"></script>
<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Compras > Internación > Expediente > <strong>Entregas</strong>";
</script>
</body>
</html>
