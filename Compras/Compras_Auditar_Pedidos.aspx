...
<div class="pie_gris">
    <div class="pull-left">
        <a id="btnVerExp" class="btn pull-left">Ver Expediente</a>
        <a id="btnPedidos" class="btn pull-left" style="margin-right: 5px;">Pedidos</a>
        <a id="btnHC" class="btn pull-left" style="margin-right: 5px;">Ver HC</a>
        <a id="btnVerDocu" class="btn pull-left" style="margin-right: 5px;">Ver Docu</a>     
    </div>
