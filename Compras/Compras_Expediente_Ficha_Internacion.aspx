<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Compras_Expediente_Ficha_internacion.aspx.cs" Inherits="Compras_Compras_Expediente_Ficha" %>
...
<div class="container">
  <div class="contenedor_1" style="width:954px">
    <div class="contenedor_a" style="position:relative;margin-left:15px; width:920px; height:520px;">
            ...
            <div class="pull-left">
              <form class="form-horizontal" >
                 <div id="ControlApellidoyNombre" class="control-group">
                  ...
                  <div class="controls">
                    <input id="txtapellido" maxlength="60" class="span2 datos" style="width:200px; width:94%; background-color:#cccccc" type="text" tabindex="1" disabled=disabled>
                    <input id="txtPaciente" maxlength="60" class="span3 datos" type="hidden">
                    <a id="btnBuscarPaciente" href="../Turnos/BuscarPacientes.aspx?Express=0" class="btn" style="display:none"><i class="icon-search icon-black"></i></a>
                  </div>
                </div>
                    ...
                    <div class="controls">
                        ...
                        <select id="cboSeccional" class="span2 datos" style="width:255px; background-color:#cccccc" disabled=disabled></select>
                    </div>
                </div>
            ...
            <form class="form-horizontal" style="margin-bottom: 0px;">
             <div id="controlcboCodPariente" class="control-group">
               <label class="control-label">Parentesco</label>
                <div class="controls">
                    <select id="cboCodPariente" class="span2" style="height:30px; width:190px;" disabled=disabled>
                    </select>
                </div>
              </div>
              ...
              <div id="controltxtFechaBaja" class="control-group">
                ...
                <div class="controls">
                  <input id="txtFechaVencExp" maxlength="10" class="span2 habilitar" type="text" style="height: 15px;" ></div>
              </div>

              <div id="controldiv_diagnostico" class="control-group">
                  <label class="control-label">Diagnóstico</label>
                  <div class="controls">
                        <textarea id="txt_cbo_Diagnostico" class="span4 habilitar" style="width:250px;" rows="2" readonly></textarea>
              ...
              <div id="controltxtEmpresa" class="control-group">
                <label class="control-label">Empresa</label>
                    <div class="controls">
                        <input id="txtEmpresa" maxlength="50" class="span4 habilitar" type="text" style="width:250px;height: 15px;"/>
                    </div>
              </div>
              <div id="controltxtCalle" class="control-group">
                <label class="control-label">Dirección Empresa</label>
                    <div class="controls">
                        <input id="txtCalleEmpresa" maxlength="50" class="span4 habilitar" type="text" style="width:250px;height: 15px;"/>
                    </div>
              </div>
          ...
          <div class="pull-left">
            <form class="form-horizontal">
              <div id="ControlFechaNacimiento" class="control-group">
                ...
                <div class="controls">
                  <input id="txtFechaNacimiento" maxlength="10" class="span2" type="text" placeholder="dia/mes/año" style="height: 15px;" disabled=disabled>
              ...
              <div id="ControlPatología" class="control-group">
                  ...
                  <div class="controls">
                      <textarea id="txt_cbo_Patologia" class="span4 habilitar" style="width:290px;" rows="2" readonly></textarea>
              ...
              <div id="ControlCUIT" class="control-group">
                    ...
                    <div class="controls">
                        <input id="txtcuit" maxlength="11" class="span2 habilitar" type="text" style="height: 15px;"/>
                    </div>
              </div>
              ...
              <div id="checks1" class="control-group" style="margin-left:50px;">
                       <span style="width:100px;">Discapacidad</span> <input type="checkbox" class="check habilitar" id="chkDocu_Discapacidad" style="margin-top:0px; margin-right:120px;"/> 
                       <span style="width:100px;">Rec. Sueldo</span> <input type="checkbox" class="check habilitar" id="chkDocu_ReciboSueldo" style="margin-top:0px;"/> 
                       
                </div>
                <div id="checks2" class="control-group" style="margin-left:50px;">
                     <span style="width:100px; margin-right:63px;">DNI</span> <input type="checkbox" class="check habilitar" id="chkDocu_DNI" style="margin-top:0px; margin-right:105px;"/> 
                     <span style="width:100px;">Nac. o Casam.</span> <input type="checkbox" class="check habilitar" id="chkDocu_NacCasam" style="margin-top:0px;"/> 
                </div>
              </div>
            </form>
          </div>
              <div class="span8" style="margin-top:-10px;">
                  ...
                  <select id="cbo_EstadoExpediente" class="span4 habilitar" style="height: 30px;width: 265px;">
                  </select>
              </div>
              <div class="span10">
                  <label for="txtObservaciones" class="control-label" style="display:inline; margin-right:30px;">Observaciones</label>
                  <textarea id="txtObservaciones" class="span7 habilitar" rows="1" style="display:inline; width:80%; height: 15px;"></textarea>
              </div>
          <div class="clearfix"></div>
...
<form class="form-horizontal DP pull-left" style="margin-top:-14px;">
        ...
        <div class="tab-pane fade in" id="tab2">
          <div class="label_top_grupo">
            <div class="label_top">
              <div>Calle</div>
              <input id="txtcalle" maxlength="60" type="text" class="span3" disabled=disabled>
            </div>
            <div class="label_top">
              <div>Número</div>
              <input id="txtnumero" type="text" maxlength="10" class="span1" disabled=disabled>
            </div>
            <div class="label_top">
              <div>Piso</div>
              <input id="txtpiso" type="text" maxlength="6" class="span1" disabled=disabled>
            </div>
            <div class="label_top">
              <div>Depto.</div>
              <input id="txtdpto" type="text" maxlength="6" class="span1" disabled=disabled>
            </div>
            <div class="label_top">
              <div>Cod Postal.</div>
              <input id="txtcodpos" maxlength="10" type="text" class="span1" disabled=disabled>
            </div>
          ...
          <div class="label_top">
              <div>Localidad</div>
              <input id="txtlocalidad" maxlength="60" type="text" class="span3" disabled=disabled>
            </div>
            <div class="label_top">
              <div>Provincia</div>
              <select id="cboProvincia" type="text" class="span2" style="width:200px;" disabled=disabled>
              </select>
            </div>
          ...
          <div class="label_top_grupo">
                      <div class="label_top">
              <div>Celular</div>
              <input id="txtcelular" maxlength="60" type="text" class="span3" disabled=disabled>
            </div>
            <div class="label_top" id="ControlTelefono">
              <div>Teléfono</div>
              <input id="txttelefono" maxlength="13" placeholder="Ej. 43625910" class="span2" type="text" style="width:188px;" disabled=disabled>
            </div>
          <div class="clearfix"></div>
          </div>
        ...
        <div class="tab-pane fade in" id="tab4">
          ...
          <div class="control-group" style="margin-bottom:0px;" id="controlPMI">
              ...
              <input id="txtPMIDesde" maxlength="10" type="text" class="input-small date habilitar" style="width:80px;"/>
              <span for="txtPMIHasta">Hasta</span>
              <input id="txtPMIHasta" maxlength="10" type="text" class="input-small date hasta habilitar" style="width:80px;"/>

              <span style=" margin-right:33px;">Plan Materno</span>
              <span for="txtPMDesde">Desde</span>
              <input id="txtPMDesde" maxlength="10" type="text" class="input-small date habilitar" style="width:80px;"/>
              <span for="txtPMHasta">Hasta</span>
              <input id="txtPMHasta" maxlength="10" type="text" class="input-small date hasta habilitar" style="width:80px;"/>
          </div>
          <div class="control-group" style="margin-bottom:0px;" id="controlCodem">
              ...
              <input id="txtCodemDesde" maxlength="10" type="text" class="input-small date habilitar" style="width:80px;"/>
              <span for="txtCodemHasta">Hasta</span>
              <input id="txtCodemHasta" maxlength="10" type="text" class="input-small date hasta habilitar" style="width:80px;"/>

              <span style=" margin-right:2px;">Cert Discapacidad</span>
              <span for="txtCertificadoDiscDesde">Desde</span>
              <input id="txtCertificadoDiscDesde" maxlength="10" type="text" class="input-small date habilitar" style="width:80px;"/>
              <span for="txtCertificadoDiscHasta">Hasta</span>
              <input id="txtCertificadoDiscHasta" maxlength="10" type="text" class="input-small date hasta habilitar" style="width:80px;"/>
           ...
           <div class="control-group" style="margin-bottom:0px;" id="controlSSS">
              ...
              <input id="txtSSSDesde" maxlength="10" type="text" class="input-small date habilitar" style="width:80px;"/>
              <span for="txtSSSHasta">Hasta</span>
              <input id="txtSSSHasta" maxlength="10" type="text" class="input-small date hasta habilitar" style="width:80px;"/>
              <div style="background-color: #D8D8D8;width: 220px;margin-left: 95px;margin-top: 0px; position:absolute; display:inline;">
                ...
                <input id="txtVencimientoPatologia" maxlength="10" type="text" class="input-small date hasta habilitar" style="width:80px;margin-top: 5px;">
              </div>
          </div>
          <br />
           <div class="control-group" style="margin-bottom:0px;" id="controlTutor">
                ...
                <input id="txtTutor" maxlength="50" type="text" class="input-xxlarge habilitar" style="width:510px;"/>
           </div>
           ...
           <div class="control-group" style="margin-bottom:0px;" id="controlEstadolegal">
                ...
                <select id="cbo_EstadoLegal" class="span4 habilitar">
        ...
        <div class="tab-pane fade in" id="tab6">
           <div id="documentacion_turnos" style="height:180px; max-height:180px; overflow:auto;">
           </div>
        </div>
...
<%--<div class="btn-group dropup">
  <button id="btnPedidos" type="button" class="btn btn-default dropdown-toggle" style="display:none" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Pedidos</button>
  <ul class="dropdown-menu" >
  <li id="listaServicios"></li>
  </ul>
</div>--%>

<div class="btn-group dropup">
  <button id="btnPedidos" type="button" class="btn btn-default" style="display:none; width:100px; margin-left:15%" aria-haspopup="true" aria-expanded="true">&nbsp;Pedidos</button>
</div>


        <a id="btnEntregas" type="button" class="btn pull-left" style="display:none;width:100px">&nbsp;Entregas</a>
    ...
    <script src="../js/Hospitales/Compras/Compras_Expediente_Ficha_Internacion.js" type="text/javascript"></script>
    <script src="../js/GeneralG.js" type="text/javascript"></script>    
    <script src="../js/jquery-ui-1.9.2.custom.js" type="text/javascript"></script>
    <script src="../js/ui-datepicker-es.js" type="text/javascript"></script>    
<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Compras >  Internación > <strong>Expediente</strong>";
</script> 
</body>
</html>
