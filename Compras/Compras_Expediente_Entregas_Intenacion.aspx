<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Compras_Expediente_Entregas_Intenacion.aspx.cs" Inherits="Compras_Compras_Expediente_Entregas_Intenacion" %>
...
<%--                                        <th>
                ...
                <div id="contDET" class="contenedor_3" style="height:430px; margin-bottom:10px;">
                    ...
                    <div class="row" style="margin-left:0px;">
                            <div class="span7" style="width: 470px">
                                <input type="hidden" id="PDT_INS_ID" value=""  class="detalles"/>
                                <input id="PDT_INS_NOM" type="text" data-provide="typeahead" autocomplete="off" class="input-xxlarge detalles" style="width:397px;margin-left: 6px;display:none" disabled/>
                            </div>
                    ...
                    <div class="row" style="margin-left:5px;">
                        <div class="span4" style="width: 475px;margin-left: 10px; display:none">Depósito
                                <select id="cbo_Deposito" class="input-medium" style="width: 410px;"></select>
                        </div>
                        <div class="span4" style="width:236px;margin-left: 12px;display:none">
                                <input id="PDT_OBS" type="text" class="input-xlarge detalles" maxlength="40" style="width:185px; display:none"/>
                               
                        </div>
                        <div class="span3" style="width:380px; margin-left:80%;"> 
                            <a id="btnLimpiarDET" class="btn btn-mini">Limpiar</a>  
                            <a id="btnEntregarTodo" class="btn btn-mini btn-primary" style="width:250px; display:none"><b>Entregar Todo</b></a>
                    ...
                    <div class="pie_gris">
                        <div class="pull-right"> <label style="background-color:Yellow; display:inline">Entregado</label>
                            <a id="btnVerEntregasAnteriores" class="btn" style="display:none">Ver Entregas Anteriores al 100%</a>
                            <a id="btnPedidosVolver" class="btn" style="width:100px">&nbsp;Pedidos</a>
                            <a id="btnPrint" class="btn" style="display:inline;"><i class="icon-print"></i>&nbsp;Imprimir</a>
...
<script src="../js/Hospitales/Compras/Compras_Expediente_Entregas_Internacion.js" type="text/javascript"></script>
<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Compras > Internacion > Expediente > <strong>Entregas</strong>";
</script>
</body>
</html>
