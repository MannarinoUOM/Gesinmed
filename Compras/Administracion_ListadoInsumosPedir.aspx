<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Administracion_ListadoInsumosPedir.aspx.cs" Inherits="Compras_Administracion_ListadoInsumosPedir" %>
...
<div class="container" style="padding-top:30px; width:1000px;">
  <div class="contenedor_1" style="width:1000px; height: 460px">
   <div class="contenedor_3" style="height:410px;width:970px;">
        ...
        <div style="padding:0px 15px 0px 15px;">
           ...
           <div id="TablaDetalles" class="detalles" style="overflow:no; font-size:12px; text-align:center; white-space:nowrap;display:none; height:270px">
              <table id="detalles" class="display mano" cellspacing="0" width="100%" style="margin-bottom:30px;">
              </table>
           </div> <!-- Fin Div Tabla -->
        </div>
        <div class="clearfix"></div>
        <input type="hidden" id="nroPedido""/>
<div class="pie_gris">
    ...
    <div class="pull-right" style="height:90px;">
        <a id="btnPedir" class="btn btn-success detalles"><i class="icon-ok icon-white"></i>&nbsp;Pedir</a>
        <a id="btnExcel" class="btn btn-success detalles"><i class="icon-file icon-white"></i>&nbsp;Excel</a>
    </div>
</div>
      </div>
    </div>
...
<script src="../js/Hospitales/Compras/Administracion_ListadoInsumosPedir.js" type="text/javascript"></script>
<script src="../js/General.js" type="text/javascript"></script>
<script src="../js/ui-datepicker-es.js" type="text/javascript"></script>
<!--Barra sup--> 
<script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Compras > Administración > <strong>Listado de Insumos a Pedir</strong>";
</script> 
</body>
</html>
