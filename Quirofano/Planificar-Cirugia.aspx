<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Planificar-Cirugia.aspx.cs" Inherits="Quirofano_Planificar_Cirugia" %>
      ...
      <div id="Aguarde_Momento" style="background-color:White; display:none; width:100%; height:440px; position:absolute;">
        ...
        Aguarde un momento <img src="../img/Espere.gif" />
              ...
              <select id="cbo_Diagnostico" name="cbo_Diagnostico" class="pull-left" style="width:672px;display:none;">
                ...
                <table>
                <tr>
                <td style="width:128px; text-align:right; cursor:pointer;" class="titulo_derecho"><a onclick="FiltrarCirugia();">Cirugía</a></td>
                <td>
...
<div class="pie_gris">
  ...
  <a class="btn pull-right" id="Imprimir_IQ"><i class="icon-print"></i>&nbsp;Imprimir</a> 
