<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Solicitud_Cirugia_Programada_Listado.aspx.cs" Inherits="Solicitud_Cirugia_Programada_Listado" %>
...
<div style="position:fixed; width: 100%; height:100%; display:block; background-color:rgba(0,0,0,0.5); display:none;" id="div_opcion" >
    ...
    <div id="div_opciones_final">
        ...
        <a class="btn btn-danger" onclick="ImprimirVaucher();">Imprimir Vaucher</a> <a class="btn btn-warning" onclick="btn_Ocultar();">Cancelar</a>
            ...
            <div>
            <b>Solicitud Turno Quirúrgico - Listado </b><br />
    ...
    <link href="../css/jquery.fancybox-1.3.4.css" rel="stylesheet" type="text/css" />
    <script src="../js/Hospitales/AtConsultorio/Consulta_Cirugia_Programada_Listado.js" type="text/javascript"></script>
    <!--Barra sup-->
</body>
</html>
