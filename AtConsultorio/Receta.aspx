...
<div class="container fancywidth" style="width:80%">
  <div  class="contenedor_2" style="position:relative; margin-left:170px" >
  ...
  <div id="hastaaqui" style="width:80%">
    <div class="contenedor_a" style="position:relative;margin-left:0px; width:100%; margin-left:12%">
      ...
      <div id="my-tab-content" class="tab-content">
        ...
        <div class="tab-pane fade in" id="tab2">
          <div class="tabla" style="height:100px;margin:0px 10px 10px 10px; font-size:11px; width:98%">
          ...
          <div style="padding:0px 0px 0px 15px; height:40%; width:98%; margin-right:0px">

          <table>
           <tr><td colspan="2">Adicional <input id="txt_Adicional" type="text" maxlength="25" style="margin-left:4px;width:150px"/></td><td colspan="2">Monodroga <select id="cbo_MonoDrogas" style="width:250px;"></select></td></tr>
       
           <tr><td>U Medida <select id="cbo_medidas" class="span2" style="width:100px;"></select></td><td>Dosis <input id="txt_Dosis" type="text" class="span2" maxlength="10" style="margin-left:0px;width:80px;"/></td><td>Dosis diaria <input id="txt_Dosis_diaria" type="text" class="span2" maxlength="10" style="width:75px;"/></td><td>Presentación <select id="cbo_presentacion" class="span3" style="width:150px;"></select></td></tr>
            
           
          

            <tr><td>Observ. <input id="txt_Observaciones" type="text" class="span4" maxlength="25" style="margin-left:11px;width:200px;"/></td>
            <td><a id="btnAceptar" class="btn btn-success pull-right" style="margin-left:10px; margin-right:10px;">Agregar</a></td> 
            <td><a id="btnCancelar" class="btn btn-danger pull-right">Cancelar</a></td> 
            <td><a id="btnQuitar" class="btn btn-danger" style="display:none;">Quitar</a></td></tr>
...
<label style="display:inline" for="chkConCopia">COPIA PARA FARMACIA</label><input style="margin-top:0px; width:40px" type="checkbox" id="chkConCopia" />
</p>
</div>
