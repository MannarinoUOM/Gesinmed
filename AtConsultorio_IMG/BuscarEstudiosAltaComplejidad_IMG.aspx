<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuscarEstudiosAltaComplejidad_IMG.aspx.cs" Inherits="AtConsultorio_IMG_BuscarEstudiosAltaComplejidad_IMG" %>
...
<body>
    ...
    <script>
        parent.document.getElementById("DondeEstoy").innerHTML = "Imagenes > <strong>Buscar Ordenes de Estudio de Alta Complejidad</strong>";
    </script>
        ...
        <div class="contenedor_1 pagination-centered" style="height:450px;">
            <div class="contenedor_a" style="height:400px;">
                <div class="titulo_seccion">
                    &nbsp;&nbsp;<span>Búsqueda de Ordenes de Estudio de Alta Complejidad IMG</span></div>
         ...
         <br />
                 ...
                 <form class="form-inline" style="margin: 0px">                    
                    <div id="ControltxtFechaInicio" class="input-prepend inline control-group " style="display:inline-block;">
                            ...
                            <input class="span2 fecha" id="txtFechaInicio" maxlength="10" type="text">
                     </div>
                     ...
                     <div id="ControltxtFechaFin" class="input-prepend inline control-group " style="display:inline-block;">
                            ...
                            <input class="span2 fecha" id="txtFechaFin" maxlength="10" type="text">
                     </div>
                     ...
                     <div>&nbsp;&nbsp;&nbsp;<a id="btnBuscar" class="btn btn-info" href="#" data-backdrop="static" role="button" data-toggle="modal">
                            ...
                            <a id="btnVolver" class="btn" style="display:none"><i class=" icon-arrow-left" icon-white"></i>&nbsp;Volver</a>
                      </div>
    ...
    <script src="../js/Hospitales/AtConsultorio/BuscarEstudiosAltaComplejidad_IMG.js" type="text/javascript"></script>
    <!--Barra sup-->
