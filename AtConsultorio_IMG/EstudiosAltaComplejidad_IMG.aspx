<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EstudiosAltaComplejidad_IMG.aspx.cs" Inherits="AtConsultorio_IMG_EstudiosAltaComplejidad_IMG" %>
...
<body>
         ...
         <form class="form-horizontal" style="margin-top:-15px;">
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <div class="pie_gris">
               <%-- /AtConsultorio_IMG/BuscarEstudiosAltaComplejidad_IMG.aspx--%>
                    <a id="btnGuardar" class="btn btn-info pull-right"><i class="icon-ok"></i>&nbsp;Guardar</a>
                    <a id="btnUltimoEst" class="btn btn-inverse  pull-right"><i class="icon-ok icon-white"></i>&nbsp;Ultimo Estudio</a>
    ...
    <script src="../js/Hospitales/AtConsultorio/EstudiosAltaComplejidad_IMG.js" type="text/javascript"></script>
    <!--Barra sup-->
</body>
</html>
