...
//    }
    ...
    if ($("#Anestesista :selected").val().trim() == "") {
...
//PARTE ANESTESIA
$("#btnCargaPARTE").click(function () {
    if ($('#urg_si').is(':checked')) { urg = 1; }
    if ($('#urg_no').is(':checked')) { urg = 0; }


    document.location = "../Quirofano/PlanillaAnestesia.aspx?NHC=" + $("#afiliadoId").val() + "&cirugiaId=" + Id +
            "&anes=" + $("#Anestesista").val() + "&cir=" + $("#Cirujano").val() +
            "&diag=" + $("#txt_cbo_Diagnostico").val() + "&cirugi=" + $("#txt_cirugias").val() + "&ayt=" + $("#Ayte1").val() + "&ane=" + $("#Anestesia option:selected").text() + "&tipo=2" + "&urg=" + urg; // planilla nueva";
});
