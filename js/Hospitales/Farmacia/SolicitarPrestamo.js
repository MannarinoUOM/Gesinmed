...
$("#btnPedidos").click(function () {
    window.location = "SolicitarPrestamo_Buscar.aspx";
});
    ...
    $.fancybox(
        {
            ...
            'href': '../Impresiones/SolicitarPrestamo_Print.aspx?DevolucionId=' + Pedido_Id,
            'width': '75%',
            'height': '75%',
            'autoScale': false,
            'transitionIn': 'none',
...
function LoadPedido() {
    $.ajax({
        type: "POST",
        url: "../Json/Farmacia/Farmacia.asmx/BUSCAR_FAR_PEDIDO_PRESTAMO_CAB_BY_ID",
        data: '{Id: "' + Pedido_Id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function LoadDetalles() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Farmacia/Farmacia.asmx/BUSCAR_FAR_PEDIDO_PRESTAMO_DET_BY_ID",
        data: '{Id: "' + Pedido_Id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
$("#btnConfirmarPedido").click(function () {
    if (confirm("¿Desea confirmar la solicitud?")) {
...
function Delete_Detalles() {
    ...
    $.ajax({
        data: json,
        url: "../Json/Farmacia/Farmacia.asmx/FAR_SOLICITAR_PRESTAMO_DET_DELETE",
        type: "POST",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Insert_Detalles() {
    ...
    $.ajax({
        data: json,
        url: "../Json/Farmacia/Farmacia.asmx/INSERT_FAR_SOLICITAR_PRESTAMO_DET",
        type: "POST",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Insert_Pedido() {
    ...
    $.ajax({
        data: json,
        url: "../Json/Farmacia/Farmacia.asmx/INSERT_FAR_SOLICITAR_PRESTAMO_CAB",
        type: "POST",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Insert_PPS_Det_Cargado(Resultado) {
    ...
    $.fancybox(
        {
            'autoDimensions': false,
            'href': '../Impresiones/SolicitarPrestamo_Print.aspx?DevolucionId=' + Id,
            'width': '75%',
            'height': '75%',
            'autoScale': false,
            'transitionIn': 'none',
            ...
            'enableEscapeButton': false,
            'onClosed': function () {
                window.location.href = "SolicitarPrestamo.aspx";
            },
            'preload': true,
            'onComplete': function f() {
                jQuery.fancybox.showActivity();
