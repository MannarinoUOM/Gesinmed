function ListarInsumos() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_LISTAR",
...
$("#btn_guardar_insumo").click(function () {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_CREAR_NOMBRE",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            $("#INSUMOALTA_Div").hide();
...
function CargarInsumo() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_CARGARINSUMO_X_ID",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
...
function ListarOrtopedias() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_ORTOPEDIAS_LISTAR",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var lista = Resultado.d;
...
function ListarServicios() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_SERVICIOS_LISTAR",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var lista = Resultado.d;
...
function ListarMarcas() {    
    $.ajax({
        type: "POST",        
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_MARCAS_LISTAR",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var lista = Resultado.d;
...
function ListarMovimientos() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_MOTIVO_LISTAR",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var lista = Resultado.d;
...
function GuardarMarca() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_MARCA_INSERTAR",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            EdicionMarca = 0;
...
function GuardarServicio() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_SERVICIOS_ALTA",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            EdicionServicio = 0;
...
function GuardarOrtopedia() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_ORTOPEDIAS_ALTA",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            EdicionOrtopedia = 0;
...
function ListarEtiquetaxInsumo(InsumoId) {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_LISTAR_ADM_FILTRO",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var lista = Resultado.d;
...
function ListarEtiquetaxInsumoDET(InsumoId) {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_LISTAR_ADM_DET",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var lista = Resultado.d;
...
$("#btn_alta_guardar").click(function () {
    ...
    if (EditandoCodigoBarra != 0) {        
        ...
        $.ajax({
            type: "POST",
            data: json,
            url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_INSERTAR",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
                ListarInsumos_ADM();
...
function CargarxCB(CB) {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_CARGAR_X_CODBARRA",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var ins = Resultado.d;
...
function GuardarInsumoxCB() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_ACTUALIZAR_X_CODBARRA",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            $("#ALTA_Div").hide();
...
$("#btn_guardar_baja").click(function () {
    if (BajaCodigoBarra != 0) {
        ...
        $.ajax({
            type: "POST",
            data: json,
            url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_UTILIZAR_X_CODBARRA",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
                var ins = Resultado.d;
...
function InsumoEliminar(Insumo) {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_ELIMINAR",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var ins = Resultado.d;
...
function Imprimir(Cuales) {
    ...
    if (aImprimir.length < 2) {        
        ...
        $.fancybox(
        {
            ...
            'href': '../Impresiones/Quirofano/EtiquetaInsumo.aspx?codigos=' + aImprimir,
            'width': '75%',
            'height': '75%',
            'autoScale': false,
            'transitionIn': 'none',
    ...
    $("#btn_guardar_subrubro").click(function () {        
        ...
        $.ajax({
            type: "POST",
            data: json,
            url: "../Json/Quirofano/Quirofano_.asmx/QUIROFANO_EXTRA_ALTATIPO",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
                var ins = Resultado.d;
    ...
    $("#btn_guardar_medida").click(function () {
        ...
        $.ajax({
            type: "POST",
            data: json,
            url: "../Json/Quirofano/Quirofano_.asmx/QUIROFANO_EXTRA_ALTAMEDIDA",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
                var ins = Resultado.d;
    ...
    function CargarTipo(TipoId, RubroId, QueCargo, SeleccionarId) {
        ...
        $.ajax({
            type: "POST",
            data: json,
            url: "../Json/Quirofano/Quirofano_.asmx/QUIROFANO_EXTRA_LISTARTIPO",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
                var lista = Resultado.d;
    ...
    function CargarMedida(MedidaId, RubroId, TipoId, QueCargo, SeleccionarId) {
        ...
        $.ajax({
            type: "POST",
            data: json,
            url: "../Json/Quirofano/Quirofano_.asmx/QUIROFANO_EXTRA_LISTARMEDIDA",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
                var lista = Resultado.d;
    ...
    function ImprimirListado() {
        ...
        var Sitio = '../Impresiones/Quirofano/ListadoInsumos.aspx?INSUMOID=' + INSUMOID + "&PDESDE=" + PDESDE + "&FHASTA=" + FHASTA + "&SERVICIOID=" + SERVICIOID + "&TIPOID=" + TIPOID + "&MEDIDAID=" + MEDIDAID;

        if ($("#ck_detallada").is(':checked')) {
            Sitio = '../Impresiones/Quirofano/ListadoInsumosCompleto.aspx?INSUMOID=' + INSUMOID + "&SERVICIOID=" + SERVICIOID + "&TIPOID=" + TIPOID + "&MEDIDAID=" + MEDIDAID;
        }
