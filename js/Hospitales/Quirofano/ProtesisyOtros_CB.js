...
function f_Imprimir() {
    $.fancybox({
            ...
            'href': '../Impresiones/Quirofano/ProtesisyOtros2.aspx?Id=' + Id,
            'width': '95%',
            'height': '95%',
            'autoScale': false,
            'transitionIn': 'none',
...
function DeleteDetalles() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Quirofano/Quirofano_.asmx/Quirofano_Extra_Protesis_Borrar_Det",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: GuardarCab,
...
function GuardarDetalles(Resultado) {
    ...
    //var json = JSON.stringify({ "p": objMedicamentos[j] });
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Quirofano/Quirofano_.asmx/Quirofano_Extra_Protesis_Guardar_Det",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: Impresion,
...
function CargarProtesisDetalle(Resultado) {
    ...
    $.each(Lista, function (index, p) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Quirofano/Quirofano_.asmx/Quirofano_Extra_Protesis_Lista_Det",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: CargarTabla,
...
$("#btn_guardar_insumo").click(function () {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_CREAR_NOMBRE_AUTOMATICO",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            $("#INSUMOALTA_Div").hide();
...
$("#btn_alta_guardar").click(function () {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_INSERTAR_AUTOMATICO",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var lista = Resultado.d;
...
function CargarxCB(CB) {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Quirofano/Quirofano_.asmx/INSUMO_EXTRA_CARGAR_X_CODBARRA_NOUSADO",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var ins = Resultado.d;
