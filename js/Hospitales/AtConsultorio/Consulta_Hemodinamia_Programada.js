...
function MedicoGuardar() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Guardar_Atencion_Hemodinamia_MedicoExterno_Guardar",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function () {
...
function ListarMedicosExternos() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Hemodinamia.asmx/Guardar_Atencion_Hemodinamia_MedicoExterno_Listar",        
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function CargarCirugia() {
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/AtConsultorioHemodinamiaCargar",
        data: '{PacienteId: "' + NHC + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
$("#btn_guardar").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Guardar_Atencion_Hemodinamia_Guardar",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Imprimir() {
    self.location = "../Impresiones/CDGeneralHemodinamia.aspx?Protocolo=" + Protocolo;
}
...
$("#btn_reprogramar").click(function () {
    ...
    if (r == true) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/AtConsultorioHemodinamiaProgramadaReestablecerTurno",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
