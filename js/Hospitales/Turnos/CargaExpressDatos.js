...
$(document).ready(function () {
   ...
   // if (GET["TLC"] != 'undefined') { TLC = GET["TLC"]; }

    if (GET["TLC"] != 'undefined' || GET["TLC"] != "" || GET["TLC"] != null) { TLC = GET["TLC"]; }
    if (GET["mono"] != 'undefined' || GET["mono"] != "" || GET["mono"] != null) { monotributista = GET["mono"]; }
...
$('#desdeaqui').click(function () {
    ...
    document.location = "ConfirmarTurnos.aspx?MedicoID=" + Medico + "&EspecialidadId=" + Especialidad + "&Fecha=" + Fecha + "&Hora=" + Hora + "&Primera=" + Primera + ST + "&TurnoTelefonico=" + TurnoTelefonico + "&Actual=" + $("#afiliadoId").val() + "&Express=1" + "&Ids=" + objTurnos + "&TLC=" + TLC + "&mono=" + monotributista;
});
