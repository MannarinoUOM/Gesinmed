...
function RecargarPagina(url) {
    document.location = "../Hemodinamia/Planificar-Cirugiahemodinamia.aspx" + url + "&FECHA_TRAIDA=" + fecha_traida;
}
...
$("#btnCancelarPedidoTurno2").click(function () {
    document.location = "Planificar-Hemodinamia.aspx?FECHA_TRAIDA=" + fecha_traida;
});
...
function List_Diagnostico(Id, estado, Cirugia_id) {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Hemodinamia.asmx/Diagnostico_Planificar_Cirugia",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function ListMotivo(Motivo_id) {
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/ListMotivo",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
            var Lista = Resultado.d;
...
function List_Medicos_Quirofano() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/List_Medicos_Hemodinamia",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function ListaCirujano() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/List_Medicos_HemodinamiabyEsp",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function ListaCirugia(Id, estado, Cirugia_id) {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Hemodinamia.asmx/ListaCirugia",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
$("#btn_edicion_cirugia").click(function () {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Hemodinamia.asmx/Cirugia_Planificar_Cirugia",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
$("#btn_suspender_cirugia_provisoria").click(function () {
    $("#btnSuspender").click();
});
...
$("#btnSuspender").click(function () {
    ...
    if (Motivo > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/SuspenderCirugia",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
$("#btn_reanudar_cirugia_provisoria").click(function () {
    $("#btnReanudar").click();
});
...
$("#btnReanudar").click(function () {
    ...
    if (Motivo > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/ReanudarCirugia",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function ImprimirSuspension(Id) {
    $.fancybox(
        {
            'autoDimensions': false,
            'href': '../Impresiones/Hemodinamia/Hemodinamia_Cir_Suspendidas.aspx?Cirugia_Id=' + Id + '&Fecha=' + $("#fecha_cirugia").val(),
            'width': '95%',
            'height': '95%',
            'autoScale': false,
            'transitionIn': 'none',
...
$("#btn_diagnostico_guardar").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Guardar_Diagnostico_PlanificarCirugia",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function () {
...
$("#btn_cirugia_guardar").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Guardar_Cirugia_PlanificarCirugia",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function () {
...
function EliminarCirugia() {
    ...
    if (r == true) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/Eliminar_Cirugia_PlanificarCirugia",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function () {
...
$("#btn_diagnostico_eliminar").click(function () {
    ...
    if (r == true) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/Eliminar_Diagnostico_PlanificarCirugia",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function () {
...
$("#btnBorrar").click(function () {
    ...
    var r = confirm("¿Está seguro que desea eliminar la cirugía?");
    if (r == true) {
        var json = JSON.stringify({ "Id": Id });
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/BorrarCirugia",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function GuardarLaCirugia() {
    ...
    if (q.cirujano_id < 1 || q.cirujano_id == "") {
        alert("Falta Seleccionar el Cirujano");
        return;
    }
    ...
    //28/03/2016 - Pedido por Roxana
    //Esto es para bloquear el botón una vez pulsado y evitamos más de un click.
    //$("#btnGuardar").attr('disabled', 'disabled');

    var json = JSON.stringify({ "qobj": q });
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/GuardarCirugia",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Linkear(Id) {
    if (IM_Guardo == 0) {
        ...
        cambio = false;
        if (ProtocoloNuevo) {
            window.location = "CargadeTurnosHemodinamia.aspx?QueryFecha=" + fecha_traida;
        }
        else {
            return;
        }
        ...
        if (cambio) {
            var r = confirm("¿Desea continuar sin guardar los datos?");
            if (r == false) {
                return;
            }
        }
        ...
        //TODO ES TO ES PARA REVISAR EL DIAGNOSTICO Y CIRUGIA....
        var cirugias_ck_final = "";
        $('#span_cirugias_cargadas input[type="checkbox"]:checked').each(function (i, el) {
            cirugias_ck_final = cirugias_ck_final + "," + el.id;
        });
        cirugias_ck_final = cirugias_ck_final.replace(",", "").replace(/ck_cir_/gi, "");


        var diagnosticos_ck_final = "";
        $('#span_diagnosticos_cargados input[type="checkbox"]:checked').each(function (i, el) {
            diagnosticos_ck_final = diagnosticos_ck_final + "," + el.id;
        });
        diagnosticos_ck_final = diagnosticos_ck_final.replace(",", "").replace(/ck_diag_/gi, "");


        if (diag_ant_guardar != diagnosticos_ck_final || cir_ant_guardar != cirugias_ck_final) {
            var r = confirm("¿Desea continuar sin guardar los datos?");
            if (r == false) {
                return;
            }
        ...
        if (IM_Guardo == 1) {
            window.location = "../Farmacia/CargarIM.aspx?ID=" + $("#afiliadoId").val() + "&Q=" + Id + "&H=1";
        }
        ...
        if (IM_Guardo == 5) {
            window.location = "Protocolosq.aspx?Id=" + Id;
        }
        ...
        //7 ParteAnestesia
        if (IM_Guardo == 7) {
            //window.location = "ParteAnestesia.aspx?Id=" + Id + "&Tipo=2"; // planilla vieja
            window.location = "PlanillaAnestesia.aspx?NHC=" + $("#afiliadoId").val() + "&cirugiaId=" + Id + 
            "&anes=" + $("#Anestesista").val() + "&cir=" + $("#Cirujano").val() +
            "&diag=" + $("#txt_cbo_Diagnostico").val() + "&cirugi=" + $("#txt_cirugias").val() + "&ayt=" + $("#Ayte1").val() + "&ane=" + $("#Anestesia option:selected").text() + "&tipo=1" + "&urg=" + urg; // planilla nueva
        }
        ...
        //9 Post
        if (IM_Guardo == 9) {
            window.location = "Post.aspx?Id=" + Id;
        }
        ...
        {
            'autoDimensions': false,
            'href': '../Impresiones/Hemodinamia/Hemodinamia_Datos_Internacion.aspx?Cirugia_id=' + Id,
            'width': '95%',
            'height': '95%',
            'autoScale': false,
            'transitionIn': 'none',
...
function LoadCirugia() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/ListaHemodinamia_Id",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Cirugia_Cargada(Resultado) {
    ...
    $.each(Cirugias, function (index, Cirugia) {
        ...
        if (Cirugia.motivo_susp_id != 0) {
            ...
            $("#btn_ImprimirSuspension").show();

            if (Cirugia.nhc == 12007801) {                
                $("#btn_reanudar_cirugia_provisoria").show();
            }
            ...
            $("#btnReanudar").hide();
            $("#btnSuspender").show();
            $("#btn_ImprimirSuspension").hide();

            if (Cirugia.nhc == 12007801) {                
                $("#btn_suspender_cirugia_provisoria").show();
            }
        }
...
$("#btnCargaInsumos").click(function () {
    ...
    Linkear(Id);
    //07/04/2016
    //Se quita el guardado automatico porque se guardaba en pantallas diferentes cosas
    //$("#btnGuardar").click();
});
...
$("#btnIndicaciones").click(function () {
    if ($(this).attr('disabled')) { return; }    
    if ($("#Cama :selected").val() == "120000132" || $("#Cama :selected").val() == "120000133") {
...
$("#btnParteAnestesia").click(function () {
    ...
    if ($('#urg_si').is(':checked')) { urg = 1; }
    if ($('#urg_no').is(':checked')) { urg = 0; }
...
$("#btn_cancelar").click(function () {
    if (QueryFecha != '')
        window.location = "CargadeTurnosHemodinamia.aspx?QueryFecha=" + QueryFecha;
    else
        //window.location = "CargadeTurnos.aspx";
        window.location = "CargadeTurnosHemodinamia.aspx?QueryFecha=" + $("#fecha_cirugia").val();
});
...
function Cargar_Sala_y_Cama() {
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Cargar_Sala_y_Cama",
        contentType: "application/json; charset=utf-8",
...
function UltimoAporte_OK() {
    ...
    function RealizarCambioPaciente() {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/CambiarPaciente",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function () {
                document.location = "Planificar-Hemodinamia.aspx?Cirugia_Id=" + Id;
            },
            error: errores
        });
    }
    ...
    function Quirofano_Estados() {
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/H2_HEMODINAMIA_ESTADOS",
            contentType: "application/json; charset=utf-8",
            data: '{CirugiaId: "' + Id + '"}',
            dataType: "json",
            success: function (Resultado) {
    ...
    function Listar_Medico_x_Especialidad(Especialidad, Controlador, Medico_Predeterminado, Seleccionar, SoloQuirofano) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/Listar_Medico_x_Especialidad",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
    ...
    function FiltrarCirugia() {        
        var filtro = prompt("Ingrese el filtro de Cirugía", "");
    ...
    $("#btn_ImprimirSuspension").click(function () {
        ImprimirSuspension(Id);
    });
    ...
    function ListaDiagnostico_Cargado(Resultado) {
        ...
        diag_ant_guardar = diagnosticos_listas_cargadas;
    ...
    $("#fecha_cirugia").change(function () {
        var r = confirm("¿Realmente desea cambiar la fecha de la cirugía del paciente " + $("#CargadoApellido").html() + "?.");
        if (r == true) {
            return;
        } else {
            window.location = "CargadeTurnosHemodinamia.aspx?QueryFecha=" + $("#fecha_cirugia").val();
    ...
    $("#Hora, #Hora_Inicio, #Hora_Fin, #urg_si, #urg_no, #txt_cbo_Diagnostico, #txt_cirugias, #Peso, #Sala, #Cama, #Especialidad, #Cirujano, #Ayte1, #Ayte2, #Ayte3, #Monitorista, #Anestesista, #Anestesia, #Instrumentadora, #Circulante, #Cirujano_Externo, #Matricula_Cirujano_Externo, #Hemo, #chkHemo, #chkRayos, #chkAnpa, #chkMonitoreo, #MedSolicitante, #Observaciones").change(function () { cambio = true; });




    function CargarNuevoExtra(Id) {
        var json = JSON.stringify({ "CirugiaID": Id });
        $.ajax({
            type: "POST",
            data: json,
            url: "../Json/Hemodinamia.asmx/Hemodinamia_Extra_EsViejo",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Respuesta) {
                var dato = Respuesta.d;
                if (dato) {
                    window.location = "HemodinamiaProtesisyOtros.aspx?Id=" + Id;                    
                }
                else {
                    window.location = "HemodinamiaProtesisyOtros_CB.aspx?Id=" + Id;
    ...
    function VerificarUsuarioCirujano() {
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/VerificarUsuarioCirujano",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
                if (Resultado.d == 0) {
    ...
    $("#cboConsentimientos").change(function () {
        if ($("#cboConsentimientos").val() > 0) {
            $.ajax({
                type: "POST",
                url: "../Json/Internaciones/IntSSC.asmx/traerUsuario",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (Resultado) {

                    window.open("../Internacion/consentimientoFirma.aspx?afiliadoId=" + $("#afiliadoId").val() + "&tipo=H" + "&UsuarioId=" + Resultado.d + "&nombreArchivo=" + $("#cboConsentimientos option:selected").html() + "&cual=" + $("#cboConsentimientos").val(), "_blank");
                },
                error: errores
            });
        }
