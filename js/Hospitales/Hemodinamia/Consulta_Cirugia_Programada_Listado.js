...
//----------------
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Hemodinamia_Programada_UltimaEtapa_x_Paciente_Listar",
...
function CargarEstadoActual(CirugiaProgramadaID) {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Hemodinamia_Programada_ProximaEtapa",
...
function Guardar(Resultado) {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Hemodinamia_Programada_GuardarProximaEtapa",
...
function Anular(CirugiaProgramadaID) {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Hemodinamia_Programada_Anular",
        data: '{CirugiaProgramadaID: "' + CirugiaProgramadaID + '" }',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (Resultado) {
...
function ImprimirVaucher(Id) {
    $.fancybox(
        {
            ...
            'href': '../Hemodinamia/Solicitud_Cirugia_Programada_Vaucher.aspx?TurnoId=' + CirugiaActual,
            'width': '95%',
            'height': '95%',
            'autoScale': false,
            'transitionIn': 'none',
    ...
    $(document).ready(function () {
        ...
        $(".fAviso").change(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../Json/Hemodinamia.asmx/HemodinamiaProgramadaGuardarFechaAviso",
