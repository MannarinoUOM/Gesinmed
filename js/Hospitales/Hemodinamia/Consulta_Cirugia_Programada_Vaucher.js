...
function guardar() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/HemodinamiaProgramadaGuardarVaucher",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function () {
            imprimir("../Impresiones/Hemodinamia/HemodinamiaTurnoVaucher.aspx?CirugiaProgramadaID=" + CirugiaActual + "&PDF=1", 0);
        },
        error: errores
    });
}
...
function traerDatos(id) {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/HemodinamiaProgramadaImprimirVaucher",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
