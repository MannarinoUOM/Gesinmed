...
function Guardar() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Guardar_Pre_Anestesico",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function f_Imprimir() {
    $.fancybox({
        ...
        'href': '../Impresiones/Hemodinamia/Pre_Anestesico.aspx?Id=' + Id,
        'width': '95%',
        'height': '95%',
        'autoScale': false,
        'transitionIn': 'none',
...
function Cargar_Preanestesico(Quiro_Id) {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Cargar_Preanestesico",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Cargar_Preanestesico_Cargado(Resultado) {
    ...
    function Listar_Insumos_Utilizados() {
        $.ajax({
            type: "POST",
            data: "{CirugiaID: '" + Id + "'}",
            url: "../Json/Hemodinamia.asmx/Listar_Insumos_PreAnestesia",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
                var Lista = Resultado.d;
