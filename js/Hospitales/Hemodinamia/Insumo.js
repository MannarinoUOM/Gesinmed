...
$(document).ready(function () {
    ...
    if (Tipo == 2) {
        parent.document.getElementById("DondeEstoy").innerHTML = "Hemodinamia > Turnos > Planificar Cirugía > <strong>Insumos Qx</strong>";
        $("#btn_imprimir").show();
    }
    if (Tipo == 3) {
        parent.document.getElementById("DondeEstoy").innerHTML = "Hemodinamia > Turnos > Planificar Cirugía > Post > <strong>Insumos Post</strong>";
    }
    if (Tipo == 1) {
        parent.document.getElementById("DondeEstoy").innerHTML = "Hemodinamia > Turnos > Planificar Cirugía > Pre > <strong>Insumos Pre</strong>";
    }
...
function Delete_Insumos() {
    var json = JSON.stringify({ "Cirugia_Id": Id, "Tipo": Tipo });
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/DeleteInsumosQuirurgicos",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function Delete_Insumos_Cargado(Resultado){      
    ...
    var json = JSON.stringify({ "Cirugia_Id": Id, "Insumos": objMedicamentos_guardados, "Tipo": Tipo  });            
            $.ajax({
                type: "POST",
                url: "../Json/Hemodinamia.asmx/InsertInsumosQuirurgicos",
                data: json,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: Print,
...
function Print() {
    ...
    if (imprimir_comprobate && Tipo == 2) {
        ...
        $.fancybox(
        {
            ...
            'href': '../Impresiones/Hemodinamia/Hemodinamia_Insumos.aspx?CirugiaId=' + Id + "&Tipo=" + Tipo,
            'width': '95%',
            'height': '95%',
            'autoScale': false,
            'transitionIn': 'none',
...
$("#btnAgregarMedicamentoPlantilla").click(function () {
    ...
    if (valid) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Hemodinamia.asmx/InsertPreQuirurgicos_Plantilla",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function LoadPlantilla_cargada() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/ListInsumosPlantilla_cargada_POS",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function LoadPlantilla() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/Cargar_Plantilla_Cargado",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: LoadPlantilla_Cargado,
...
function List_Insumos(Nombre) {
    $.ajax({
        type: "POST",
        data: '{Insumo: "' + Nombre + '"}',
        url: "../Json/Hemodinamia.asmx/H2_HEMODINAMIA_LISTAR_INSUMOS",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
