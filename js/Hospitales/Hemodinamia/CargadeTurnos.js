...
function Buscar_Cirugias(cuales) {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/ListaCirugias",
        data: json,
    ...
    $.ajax({
        type: "POST", url: "../Json/Hemodinamia.asmx/ListaCirugias_Totales",
        data: json, 
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function TengoPermiso() {    
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/TengoPermisoPlanificarCirugia",        
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Pedidos_Cargados(Resultado) {
    ...
    $.each(Turnos, function (index, Pedido) {
        ...
        Tabla_Datos = Tabla_Datos + " style='cursor:pointer;' class='" + color + "' onclick=Ventana('Planificar-Hemodinamia.aspx?Cirugia_Id=" + Pedido.Id + "');";
    ...
    if (Tabla_Datos == "") {
        ...
        Tabla_Datos = "</tbody></table> <div style='text-align:center;'>No hay Hemodinamias <b>" + texto_tipo_cirugia + "</b> para este día</div>";
        Tabla_Fin = "";
    }
...
$("#btnPlanificar").click(function () {
    document.location = "Planificar-Hemodinamia.aspx?FECHA_TRAIDA=" + $("#fecha").val();
});
...
$("#btnImprimir").click(function () {
    ...
    //verificar existencia y generacion de historial
    var json = JSON.stringify({ "id": 0, "fecha": $("#fecha").val(), "dadodebaja": false, "turno": 0, "cuales": c_cuales, "ruta": "../Impresiones/Hemodinamia/Hemodinamia_Turnos.aspx?Fecha=" + Fecha + "&cuales=" + c_cuales });
    //alert(json);
    $.ajax({
        type: "POST",
        url: "../Json/Hemodinamia.asmx/GenerarRegistroTurnoParteQuirurgico",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
                ...
                $.fancybox(
        {
            ...
            'href': '../Impresiones/Hemodinamia/Hemodinamia_Turnos.aspx?Fecha=' + Fecha + "&cuales=" + c_cuales,
            'width': '95%',
            'height': '95%',
            'autoScale': false,
            'transitionIn': 'none',
