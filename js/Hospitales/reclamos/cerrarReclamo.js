...
function cargarDatos(lista) {
    ...
    //$("#adjunto").attr("src", "../reclamosAdjuntos/" + lista[0].adjunto);
    //ruta = lista[0].adjunto;
    ruta = "../reclamosAdjuntos/" + lista[0].adjunto;
...
$("#btnImprmir").click(function () {
    ...
    $.fancybox({
        'href': '../Impresiones/reclamos/reclamoImpresion.aspx?id=' + id + '&estado=' + estado,
        'width': '80%',
        'height': '80%',
        'autoScale': false,
        'transitionIn': 'elastic',
...
$("#btnCerrarReclamo").click(function () {
    ...
    if (r) {
        ...
        $.ajax({
            type: "POST",
            data: json,
            url: "../Json/Odontologia.asmx/ReclamoCerrar",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (Resultado) {
